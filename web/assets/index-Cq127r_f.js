import { dq as baseEach, dr as baseIteratee, ds as isArray, dt as baseAssignValue, du as baseForOwn, dv as isSymbol, dw as enUS, bX as useSsrAdapter, E as inject, aq as onMounted, F as watchEffect, cF as murmur2, a as c, A as ref, dx as configProviderInjectionKey, d as defineComponent, h, dg as __unplugin_components_3, dy as resolveSlotWithTypedProps, z as computed, c as cB, b as cE, g as cM, c3 as resolveWrappedSlot, c6 as resolveSlot, u as useConfig, S as useLocale, U as useTheme, dz as heatmapLight, i as useRtl, Z as useThemeClass, a4 as createKey, dA as pxfy, a5 as useI18n, bu as usePlayHistoryStore, bb as usePlayerStore, a7 as openBlock, a8 as createElementBlock, ab as createBaseVNode, ac as toDisplayString, ad as unref, aa as normalizeClass, bv as setAnimationClass, ak as createVNode, as as withCtx, bj as __unplugin_components_2$1, ae as Fragment, af as renderList, ah as createCommentVNode, b7 as createTextVNode, be as Scrollbar, ap as _export_sfc } from "./index-BMNXZoHW.js";
import { a as __unplugin_components_1, _ as __unplugin_components_3$1 } from "./text-Djacg5es.js";
...
function useLoadingStyleClass(props, themeRef) {
  ...
  onMounted(() => {
    watchEffect(() => {
      ...
      const className = "heatmap-loading-".concat(loadingColorHash);
      const animationName = "heatmap-loading-animation-".concat(loadingColorHash);
      loadingClassRef.value = className;
      const cnode = c([c(".".concat(className), "\n          animation: 2s ".concat(animationName, " infinite cubic-bezier(0.36, 0, 0.64, 1);\n        ")), c("@keyframes ".concat(animationName), "\n          0% {\n            background: ".concat(loadingColorStart, ";\n          }\n          40% {\n            background: ").concat(loadingColorEnd, ";\n          }\n          80% {\n            background: ").concat(loadingColorStart, ";\n          }\n          100% {\n            background: ").concat(loadingColorStart, ";\n          }\n        "))]);
      cnode.mount({
        id: loadingColorHash,
        ssr: adapter,
...
const HeatmapColorIndicator = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return h("div", {
        class: "".concat(clsPrefix, "-heatmap-color-indicator")
      }, h("span", {
        class: "".concat(clsPrefix, "-heatmap-color-indicator__label")
      }, (_a = slots["leading-text"]) === null || _a === void 0 ? void 0 : _a.call(slots)), h("div", {
        class: "".concat(clsPrefix, "-heatmap-color-indicator__cells")
      }, colors.map((color, index2) => h("div", {
        key: index2,
        class: "".concat(clsPrefix, "-heatmap-color-indicator__cell"),
        style: {
...
const Rect = defineComponent({
  ...
  setup(props) {
    ...
    const defaultTooltipContentRef = computed(() => {
      ...
      return props.data.value !== null ? "".concat(date, " ").concat(props.data.value) : date;
    });
    return {
      cssVars: cssVarsRef,
  ...
  render() {
    ...
    const triggerNode = h("div", {
      class: ["".concat(mergedClsPrefix, "-heatmap-rect"), loading && "".concat(mergedClsPrefix, "-heatmap-rect--loading"), loading && this.loadingClass],
...
const __unplugin_components_2 = defineComponent({
  ...
  setup(props) {
    ...
    const dataMonthLabelsRef = computed(() => {
      ...
      return Object.entries(monthStats).filter(([, stats]) => stats.weekCount >= 3).sort(([a], [b]) => a.localeCompare(b)).map(([month, stats]) => {
        const monthDate = new Date(parseISO("".concat(month, "-01")));
        return {
          name: format(monthDate, monthFormat, {
            locale
          }),
  ...
  render() {
    ...
    return h("div", {
      class: [themeClass, "".concat(mergedClsPrefix, "-heatmap"), rtlEnabled && "".concat(mergedClsPrefix, "-heatmap--rtl")],
      style: cssVars
    }, h("div", {
      class: "".concat(mergedClsPrefix, "-heatmap__content")
    }, h("table", {
      class: "".concat(mergedClsPrefix, "-heatmap__calendar-table")
    }, showMonthLabels && h("thead", null, h("tr", null, showWeekLabels && h("th", {
      class: "".concat(mergedClsPrefix, "-heatmap__week-header-cell")
    }), monthLabels.map((monthLabel, index2) => h("th", {
      key: "month-".concat(index2),
      colspan: monthLabel.colSpan,
      class: "".concat(mergedClsPrefix, "-heatmap__month-label-cell")
    }, monthLabel.name)))), h("tbody", null, weekLabels.map((weekLabel, rowIdx) => {
      return h("tr", {
        key: "row-".concat(rowIdx)
      }, showWeekLabels && h("td", {
        class: "".concat(mergedClsPrefix, "-heatmap__week-label-cell")
      }, weekLabel.visible ? weekLabel.label : null), (heatmapMatrix[rowIdx] || []).map((day, weekIdx) => {
        return day.value !== null ? h("td", {
          key: "day-".concat(rowIdx, "-").concat(weekIdx),
          class: "".concat(mergedClsPrefix, "-heatmap__day-cell")
        }, h(Rect, {
          mergedClsPrefix,
          data: day,
          color: day.color,
          ...
          key: "empty-".concat(rowIdx, "-").concat(weekIdx),
          class: "".concat(mergedClsPrefix, "-heatmap__day-cell")
        }, h("div", {
          class: "".concat(mergedClsPrefix, "-heatmap__empty-cell")
        }));
      }));
    })))), h("div", {
      class: "".concat(mergedClsPrefix, "-heatmap__footer")
    }, resolveWrappedSlot($slots.footer, (children) => children && h("div", {
      class: "".concat(mergedClsPrefix, "-heatmap__footer")
    }, children)), h("div", {
      class: "".concat(mergedClsPrefix, "-heatmap__indicator")
  ...
  setup(__props) {
      ...
      try {
          ...
          for (let i = 0; i < playCount; i++) {
            ...
            if (existingSong) {
              ...
              dailyMap[dateKey].songs.set(songId, {
                ...
                artist: ((_b = (_a = music.ar) == null ? void 0 : _a[0]) == null ? void 0 : _b.name) || ((_d = (_c = music.artists) == null ? void 0 : _c[0]) == null ? void 0 : _d.name) || "Unknown Artist",
                playCount: 1
              });
            }
          }
        ...
        for (let d = new Date(startDate); d <= endDate; d.setDate(d.getDate() + 1)) {
          ...
          heatmapDataArray.push({
            timestamp: d.getTime(),
            value: (dayData == null ? void 0 : dayData.totalPlays) || 0
          });
        }
    ...
    const mostPlayedSong = computed(() => {
      ...
      playHistoryStore.musicHistory.forEach((music) => {
        ...
        const artist = ((_b = (_a = music.ar) == null ? void 0 : _a[0]) == null ? void 0 : _b.name) || ((_d = (_c = music.artists) == null ? void 0 : _c[0]) == null ? void 0 : _d.name) || "Unknown Artist";
    ...
    const latestNightSong = computed(() => {
      ...
      if (nightSongs.length === 0 && playHistoryStore.musicHistory.length > 0) {
        ...
        return {
          ...
          artist: ((_b = (_a = randomSong.ar) == null ? void 0 : _a[0]) == null ? void 0 : _b.name) || ((_d = (_c = randomSong.artists) == null ? void 0 : _c[0]) == null ? void 0 : _d.name) || "Unknown Artist",
          time: "凌晨 ".concat(randomHour.toString().padStart(2, "0"), ":").concat(randomMinute.toString().padStart(2, "0"))
        };
      }
      if (nightSongs.length > 0) {
        ...
        return {
          ...
          artist: ((_f = (_e = song.ar) == null ? void 0 : _e[0]) == null ? void 0 : _f.name) || ((_h = (_g = song.artists) == null ? void 0 : _g[0]) == null ? void 0 : _h.name) || "Unknown Artist",
          time: "凌晨 ".concat(randomHour.toString().padStart(2, "0"), ":").concat(randomMinute.toString().padStart(2, "0"))
        };
      }
      return null;
                  ...
                  createBaseVNode("div", _hoisted_15, [
                    (openBlock(), createElementBlock(Fragment, null, renderList(colorThemes, (color) => {
                      return createBaseVNode("div", {
                        key: color,
                        class: normalizeClass(["color-option", "color-".concat(color), { active: selectedColor.value === color }]),
                ...
                createVNode(_component_n_heatmap, {
                  ...
                  tooltip: withCtx(({ timestamp: date, value: tooltipValue }) => [
                    createBaseVNode("div", _hoisted_18, [
                      ...
                      createBaseVNode("div", _hoisted_20, toDisplayString(unref(t)("history.heatmap.playCount", { count: tooltipValue != null ? tooltipValue : 0 })), 1),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2fa9804a"]]);
export {
  index as default
};
