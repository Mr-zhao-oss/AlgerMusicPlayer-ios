import { d as defineComponent, a5 as useI18n, b5 as useUserStore, aU as useRouter, bt as useMessage, bh as useRoute, aq as onMounted, Y as watch, a7 as openBlock, a8 as createElementBlock, ak as createVNode, as as withCtx, ab as createBaseVNode, ae as Fragment, af as renderList, b7 as createTextVNode, ac as toDisplayString, ad as unref, ag as normalizeStyle, aQ as getImgUrl, ah as createCommentVNode, be as Scrollbar, bI as PlayBottom, A as ref, bJ as checkLoginStatus, df as getUserFollowers, z as computed, ap as _export_sfc } from "./index-BMNXZoHW.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const followersTitle = computed(
      () => targetUserName.value ? targetUserName.value + t("user.follower.userFollowersTitle") : t("user.follower.myFollowersTitle")
    );
    ...
    const loadFollowerList = async () => {
      ...
      try {
        ...
        if (!(data == null ? void 0 : data.followeds)) {
        ...
        createVNode(_component_n_scrollbar, { class: "h-full" }, {
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_2, [
              followerListLoading.value && followerList.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_3, [
                ...
                createBaseVNode("section", _hoisted_6, [
                  createBaseVNode("h1", {
                    ...
                    targetUserName.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      createTextVNode(toDisplayString(targetUserName.value + unref(t)("user.follower.userFollowersTitle")), 1)
                    ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      createTextVNode(toDisplayString(unref(t)("user.follower.myFollowersTitle")), 1)
                    ], 64))
                  ], 512)
                ]),
                followerList.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_7, [
                  _cache[2] || (_cache[2] = createBaseVNode("i", { class: "ri-user-heart-line text-5xl mb-4 opacity-50" }, null, -1)),
                  createBaseVNode("p", null, toDisplayString(unref(t)("user.follower.noFollowers")), 1)
                  ...
                  followerListLoading.value ? (openBlock(), createElementBlock("div", _hoisted_18, [
                  ...
                  ])) : hasMoreFollowers.value ? (openBlock(), createElementBlock("div", _hoisted_20, [
                    ...
                    }, toDisplayString(unref(t)("user.follower.loadMore")), 1)
                  ])) : followerList.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_21, " — " + toDisplayString(unref(t)("common.noMore") || "没有更多了") + " — ", 1)) : createCommentVNode("", true)
                ]))
              ], 64))
            ])
          ]),
...
const followers = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cbc53fe2"]]);
export {
