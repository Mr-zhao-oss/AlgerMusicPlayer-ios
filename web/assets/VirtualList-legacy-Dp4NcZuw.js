...
(function () {
  System.register(['./index-legacy-B7mtj-uR.js'], function (exports, module) {
    ...
    var useMemo, computed, ref, provide, defineComponent, inject, h, VResizeObserver, mergeProps, useSsrAdapter, cssrAnchorMetaName, onMounted, onActivated, onDeactivated, depx, beforeNextFrameOnce, c, toRef, pxfy;
    return {
      setters: [module => {
        useMemo = module.c1;
        computed = module.z;
      ...
      execute: function () {
        ...
        const VVirtualList = exports("V", defineComponent({
          name: 'VirtualList',
          inheritAttrs: false,
          props: {
            showScrollbar: {
