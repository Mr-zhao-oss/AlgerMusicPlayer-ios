...
(function () {
  System.register(['./index-legacy-B7mtj-uR.js'], function (exports, module) {
    ...
    var defineComponent, h, replaceable, cB, c, cE, iconSwitchTransition, NIconSwitchTransition, resolveSlot, useStyle, NBaseIcon, toRef, NBaseLoading, createInjectionKey, cM, cNotM, watch, ref, inject, resolveSlotWithTypedProps, computed, resolveWrappedSlot, Scrollbar, Fragment, VResizeObserver, useConfig, useTheme, isSafari, useLocale, useMergedState, useFormItem, useMemo, onMounted, getCurrentInstance, watchEffect, useRtl, useThemeClass, nextTick, on, call, off, inputLight, createKey, getMargin, provide;
    return {
      setters: [module => {
        defineComponent = module.d;
        h = module.h;
        replaceable = module.dD;
        cB = module.c;
        c = module.a;
        cE = module.b;
        iconSwitchTransition = module.dE;
        NIconSwitchTransition = module.dF;
...
`, [c('>', [cE('clear', `
 ...
 `, [iconSwitchTransition({
        ...
        const NBaseSuffix = exports("N", defineComponent({
...
`, [
 ...
 `)])]);
        ...
        const __unplugin_components_0 = exports("_", defineComponent({
          name: 'Input',
          props: inputProps,
          slots: Object,
          setup(props) {
