import { aw as o, ax as s, ay as b } from "./index-BMNXZoHW.js";
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
const e = (e2, s$1, n, a, c) => {
  ...
  })(t) && s$1()), onStart: n, onMove: (t) => {
    const o2 = m(t);
    a(o2 / i.innerWidth);
  }, onEnd: (o2) => {
    const r = m(o2), e3 = i.innerWidth, s2 = r / e3, n2 = ((t) => p ? -t.velocityX : t.velocityX)(o2), a2 = n2 >= 0 && (n2 > 0.2 || r > e3 / 2), f = (a2 ? 1 - s2 : s2) * e3;
    let g = 0;
    if (f > 5) {
      const t = f / Math.abs(n2);
      g = Math.min(t, 540);
    }
    c(a2, s2 <= 0 ? 0.01 : b(0, s2, 0.9999), g);
  } });
};
export {
