;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './MusicListNavigator-legacy-0pJHpxez.js', './MvPlayer-legacy-CFWnKFW4.js'], function (exports, module) {
    'use strict';

    var defineComponent, usePlayerStore, useRouter, usePlayHistoryStore, openBlock, createElementBlock, normalizeClass, createBaseVNode, createVNode, unref, getImgUrl, __unplugin_components_1, createCommentVNode, toDisplayString, createBlock, ref, _export_sfc, navigateToMusicList, MvPlayer;
    return {
      setters: [module => {
      ...
      execute: function () {
        ...
        __vite_style__.textContent = ".line-clamp-1[data-v-e72ad828] {\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}/*$vite$:1*/";
        ...
        const _hoisted_5 = {
          class: "line-clamp-1 text-xs font-medium text-neutral-500 dark:text-neutral-400"
        };
          ...
          setup(__props) {
            ...
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", {
                ...
                lazy: "",
                "preview-disabled": ""
              }, null, 8, ["src"]), __props.item.type === "mv" ? (openBlock(), createElementBlock("div", _hoisted_1, [...(_cache[1] || (_cache[1] = [createBaseVNode("div", {
              ...
              })], -1)]))])) : createCommentVNode("", true), __props.item.type === "专辑" && __props.item.size ? (openBlock(), createElementBlock("div", _hoisted_2, [_cache[2] || (_cache[2] = createBaseVNode("i", {
                class: "ri-music-2-line"
              }, null, -1)), createBaseVNode("span", null, toDisplayString(__props.item.size), 1)])) : createCommentVNode("", true)], 2), createBaseVNode("div", _hoisted_3, [createBaseVNode("h3", _hoisted_4, toDisplayString(__props.item.name), 1), createBaseVNode("p", _hoisted_5, toDisplayString(__props.item.desc), 1)]), __props.item.type === "mv" ? (openBlock(), createBlock(MvPlayer, {
                key: 0,
                show: showPop.value,
                "onUpdate:show": _cache[0] || (_cache[0] = $event => showPop.value = $event),
                "current-mv": getCurrentMv(),
                "no-list": ""
              }, null, 8, ["show", "current-mv"])) : createCommentVNode("", true)], 2);
            };
          }
        });
        ...
        const SearchItem = exports("S", /* @__PURE__ */_export_sfc(_sfc_main, [["__scopeId", "data-v-e72ad828"]]));
      }
    };
  });
})();
