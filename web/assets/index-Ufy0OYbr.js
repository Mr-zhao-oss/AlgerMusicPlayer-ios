import { z as computed, dK as throttleFilter, dL as tryOnScopeDispose, dM as isClient, dN as toValue, dO as increaseWithUnit, F as watchEffect, dP as noop, Y as watch, A as ref, aq as onMounted, bW as getCurrentInstance, dQ as isObject, dR as timestamp, dS as createFilterWrapper, a_ as reactive, dT as tryOnMounted } from "./index-BMNXZoHW.js";
...
function useBreakpoints(breakpoints, options = {}) {
  ...
  const greaterOrEqual = (k) => {
    return useMediaQuery(() => "(min-width: ".concat(getValue2(k), ")"), options);
  };
  const smallerOrEqual = (k) => {
    return useMediaQuery(() => "(max-width: ".concat(getValue2(k), ")"), options);
  };
  ...
  return Object.assign(shortcutMethods, {
    ...
    smallerOrEqual,
    greater(k) {
      return useMediaQuery(() => "(min-width: ".concat(getValue2(k, 0.1), ")"), options);
    },
    smaller(k) {
      return useMediaQuery(() => "(max-width: ".concat(getValue2(k, -0.1), ")"), options);
    },
    between(a, b) {
      return useMediaQuery(() => "(min-width: ".concat(getValue2(a), ") and (max-width: ").concat(getValue2(b, -0.1), ")"), options);
    },
    isGreater(k) {
      return match("(min-width: ".concat(getValue2(k, 0.1), ")"));
    },
    isGreaterOrEqual(k) {
      return match("(min-width: ".concat(getValue2(k), ")"));
    },
    isSmaller(k) {
      return match("(max-width: ".concat(getValue2(k, -0.1), ")"));
    },
    isSmallerOrEqual(k) {
      return match("(max-width: ".concat(getValue2(k), ")"));
    },
    isInBetween(a, b) {
      return match("(min-width: ".concat(getValue2(a), ") and (max-width: ").concat(getValue2(b, -0.1), ")"));
    },
    current,
    active() {
      const bps = current();
