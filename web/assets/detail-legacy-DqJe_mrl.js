;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './main-legacy-CisW2O8D.js', './MusicListNavigator-legacy-0pJHpxez.js', './useScrollTitle-legacy-nHgisOEQ.js', './music-legacy-CGPq9ktk.js'], function (exports, module) {
    'use strict';

    var request, defineComponent, useI18n, useRoute, usePlayerStore, useMessage, ref, isMobile, watch, onActivated, onMounted, onDeactivated, onUnmounted, openBlock, createElementBlock, createVNode, withCtx, createBaseVNode, Fragment, renderList, normalizeStyle, unref, getImgUrl, createTextVNode, toDisplayString, createCommentVNode, normalizeClass, Transition, withDirectives, vModelText, _sfc_main$1, vShow, calculateAnimationDelay, Scrollbar, PlayBottom, computed, router, nextTick, getMusicDetail, useDateFormat, _export_sfc, l, navigateToMusicList, useScrollTitle;
    return {
      setters: [module => {
        request = module.bl;
      ...
      execute: function () {
        ...
        __vite_style__.textContent = "@charset \"UTF-8\";\n/* Artist Detail Page Styles */\n.artist-detail-page[data-v-2be28c1d] {\n  position: relative;\n}\n\n/* Hero Section */\n.hero-section[data-v-2be28c1d] {\n  min-height: 200px;\n}\n\n/* Action Bar Sticky Behavior */\n.action-bar[data-v-2be28c1d] {\n  transition: background-color 0.3s, box-shadow 0.3s;\n}\n\n/* Tab Indicator Animation */\n.tab-item[data-v-2be28c1d] {\n  z-index: 1;\n}\n.tab-item > div[data-v-2be28c1d] {\n  z-index: -1;\n}\n.tab-indicator-enter-active[data-v-2be28c1d],\n.tab-indicator-leave-active[data-v-2be28c1d] {\n  transition: all 0.2s ease;\n}\n.tab-indicator-enter-from[data-v-2be28c1d],\n.tab-indicator-leave-to[data-v-2be28c1d] {\n  opacity: 0;\n  transform: scale(0.95);\n}\n\n/* Search Slide Animation */\n.search-slide-enter-active[data-v-2be28c1d],\n.search-slide-leave-active[data-v-2be28c1d] {\n  transition: all 0.25s ease;\n}\n.search-slide-enter-from[data-v-2be28c1d],\n.search-slide-leave-to[data-v-2be28c1d] {\n  opacity: 0;\n  transform: translateY(-8px);\n  max-height: 0;\n  margin-top: 0;\n}\n.search-slide-enter-to[data-v-2be28c1d],\n.search-slide-leave-from[data-v-2be28c1d] {\n  max-height: 60px;\n}\n\n/* Virtual Song List */\n.virtual-song-list[data-v-2be28c1d]{\n  width: 100%;\n}\n.song-list[data-v-2be28c1d]{\n  width: 100%;\n}\n\n/* CSS-based virtualization for performance */\n.song-item-container[data-v-2be28c1d] {\n  content-visibility: auto;\n  contain-intrinsic-size: 0 72px; /* 预估高度，防止布局抖动 */\n}\n\n/* Compact layout - smaller item height */\n.song-list.compact-mode .song-item-container[data-v-2be28c1d] {\n  contain-intrinsic-size: 0 52px;\n}\n\n/* Album Card Animation */\n.album-card[data-v-2be28c1d] {\n  animation: fadeInUp-2be28c1d 0.4s ease backwards;\n}\n@keyframes fadeInUp-2be28c1d {\nfrom {\n    opacity: 0;\n    transform: translateY(20px);\n}\nto {\n    opacity: 1;\n    transform: translateY(0);\n}\n}\n/* Loading Spinner */\n.loading-spinner[data-v-2be28c1d] {\n  animation: pulse-2be28c1d 2s ease-in-out infinite;\n}\n@keyframes pulse-2be28c1d {\n0%, 100% {\n    transform: scale(1);\n}\n50% {\n    transform: scale(1.05);\n}\n}\n/* Hover Effects */\n.album-cover[data-v-2be28c1d] {\n  transition: box-shadow 0.3s ease;\n}\n.album-card:hover .album-cover[data-v-2be28c1d]{\n  --tw-shadow: 0 25px 50px -12px rgb(0 0 0 / 0.25);\n  --tw-shadow-colored: 0 25px 50px -12px var(--tw-shadow-color);\n  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);\n  --tw-shadow-color: rgb(34 197 94 / 0.1);\n  --tw-shadow: var(--tw-shadow-colored);\n}\n\n/* Mobile Optimizations */\n@media (max-width: 768px) {\n.hero-section[data-v-2be28c1d] {\n    min-height: auto;\n}\n.action-bar[data-v-2be28c1d]{\n    padding-top: 0.5rem;\n    padding-bottom: 0.5rem;\n}\n.tab-list[data-v-2be28c1d]{\n    width: 100%;\n}\n.tab-item[data-v-2be28c1d]{\n    flex: 1 1 0%;\n    text-align: center;\n}\n}\n/* Focus states for accessibility */\nbutton[data-v-2be28c1d]:focus-visible{\n  outline: 2px solid transparent;\n  outline-offset: 2px;\n  --tw-ring-offset-shadow: var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);\n  --tw-ring-shadow: var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);\n  box-shadow: var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000);\n  --tw-ring-opacity: 1;\n  --tw-ring-color: rgb(34 197 94 / var(--tw-ring-opacity, 1));\n  --tw-ring-offset-width: 2px;\n  --tw-ring-offset-color: #fff;\n}\nbutton[data-v-2be28c1d]:focus-visible:is(.dark *){\n  --tw-ring-offset-color: #171717;\n}\ninput[data-v-2be28c1d]:focus-visible{\n  outline: 2px solid transparent;\n  outline-offset: 2px;\n  --tw-ring-offset-shadow: var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);\n  --tw-ring-shadow: var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);\n  box-shadow: var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000);\n  --tw-ring-color: rgb(34 197 94 / 0.5);\n}/*$vite$:1*/";
        ...
        const _hoisted_7 = {
          class: "hero-section relative overflow-hidden overflow-hidden rounded-tl-2xl"
        };
        const _hoisted_8 = {
        ...
        const _hoisted_11 = {
          class: "artist-avatar-wrapper relative group"
        };
        const _hoisted_12 = {
        ...
        const _hoisted_14 = {
          class: "artist-info flex-1 text-center md:text-left"
        };
        const _hoisted_15 = {
        ...
        const _hoisted_51 = {
          class: "album-date mt-1 text-xs text-neutral-400 dark:text-neutral-500"
        };
        const _hoisted_52 = {
          key: 0,
          class: "flex items-center justify-center gap-2"
        ...
        const _sfc_main = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            const tabs = computed(() => [{
              value: "songs",
              label: t("artist.hotSongs")
            }, {
              value: "albums",
              label: t("artist.albums")
            }, {
              value: "about",
            ...
            const addToPlaylist = () => {
              ...
              const newSongs = filteredSongs.value.filter(song => !currentList.some(item => item.id === song.id));
              if (newSongs.length === 0) {
                message.info(t("comp.musicList.songsAlreadyInPlaylist"));
                return;
              }
              const newList = [...currentList, ...newSongs.map(song => ({
                ...song,
                picUrl: song.al.picUrl
              }))];
            ...
            const handlePlay = song => {
              if (song) {
                ...
                playerStore.setPlayList(songList.map(item => ({
                  ...item,
                  picUrl: item.al?.picUrl || item.picUrl
                })));
                playerStore.setPlay(song);
              } else {
                playerStore.setPlayList(filteredSongs.value.map(item => ({
                  ...item,
                  picUrl: item.al?.picUrl || item.picUrl
                })));
              }
            ...
            return (_ctx, _cache) => {
              return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(unref(Scrollbar), {
                ...
                default: withCtx(() => [createBaseVNode("div", _hoisted_2, [loading.value ? (openBlock(), createElementBlock("div", _hoisted_3, [_cache[4] || (_cache[4] = createBaseVNode("div", {
                  class: "hero-section relative h-[400px] overflow-hidden rounded-tl-2xl"
                }, [createBaseVNode("div", {
                  class: "hero-bg absolute inset-0 -top-20"
                }, [createBaseVNode("div", {
                  class: "absolute inset-0 skeleton-shimmer"
                })]), createBaseVNode("div", {
                  class: "hero-content relative z-10 px-4 pb-6 pt-4 md:px-8 md:pt-8"
                }, [createBaseVNode("div", {
                  ...
                  class: "h-6 w-20 skeleton-shimmer rounded-full"
                }), createBaseVNode("div", {
                  class: "h-10 w-1/2 md:h-12 skeleton-shimmer rounded-xl"
                }), createBaseVNode("div", {
                  class: "flex justify-center gap-4 md:justify-start"
                }, [createBaseVNode("div", {
                  class: "h-6 w-24 skeleton-shimmer rounded-lg"
                }), createBaseVNode("div", {
                  class: "h-6 w-24 skeleton-shimmer rounded-lg"
                })])])])])], -1)), createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [(openBlock(), createElementBlock(Fragment, null, renderList(8, i => {
                  return createBaseVNode("div", {
                    key: i,
                    class: "flex items-center gap-4"
                  }, [...(_cache[3] || (_cache[3] = [createBaseVNode("div", {
                    class: "h-12 w-12 skeleton-shimmer rounded-xl flex-shrink-0"
                  }, null, -1), createBaseVNode("div", {
                    class: "flex-1 space-y-2"
                  }, [createBaseVNode("div", {
                    class: "h-4 w-1/3 skeleton-shimmer rounded-lg"
                  }), createBaseVNode("div", {
                    class: "h-3 w-1/4 skeleton-shimmer rounded-lg"
                  })], -1), createBaseVNode("div", {
                    class: "h-8 w-8 skeleton-shimmer rounded-full flex-shrink-0"
                  }, null, -1)]))]);
                }), 64))])])])) : artistInfo.value ? (openBlock(), createElementBlock("div", _hoisted_6, [createBaseVNode("section", _hoisted_7, [createBaseVNode("div", _hoisted_8, [createBaseVNode("div", {
                  class: "absolute inset-0 bg-cover bg-center scale-110 blur-2xl opacity-40 dark:opacity-30",
                  style: normalizeStyle({
                    backgroundImage: `url(${unref(getImgUrl)(artistInfo.value.cover || artistInfo.value.picUrl, "800y800")})`
                  })
                }, null, 4), _cache[5] || (_cache[5] = createBaseVNode("div", {
                ...
                }, null, -1))]), createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [_cache[7] || (_cache[7] = createBaseVNode("div", {
                ...
                }, null, -1)]))])])])]), createBaseVNode("div", _hoisted_14, [_cache[10] || (_cache[10] = createBaseVNode("div", {
                  class: "artist-badge mb-2 md:mb-3"
                  ...
                  class: "iconfont icon-verified text-sm"
                }), createTextVNode(" Artist ")])], -1)), createBaseVNode("h1", {
                  ref_key: "titleElRef",
                  ref: titleElRef,
                  class: "artist-name text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white tracking-tight"
                }, toDisplayString(artistInfo.value.name), 513), createBaseVNode("div", _hoisted_15, [artistInfo.value.musicSize ? (openBlock(), createElementBlock("div", _hoisted_16, [_cache[8] || (_cache[8] = createBaseVNode("i", {
                  class: "iconfont icon-music text-primary text-lg"
                }, null, -1)), createBaseVNode("span", _hoisted_17, [createBaseVNode("span", _hoisted_18, toDisplayString(artistInfo.value.musicSize), 1), createTextVNode(" " + toDisplayString(unref(t)("artist.hotSongs")), 1)])])) : createCommentVNode("", true), artistInfo.value.albumSize ? (openBlock(), createElementBlock("div", _hoisted_19, [_cache[9] || (_cache[9] = createBaseVNode("i", {
                  class: "iconfont icon-album text-primary text-lg"
                }, null, -1)), createBaseVNode("span", _hoisted_20, [createBaseVNode("span", _hoisted_21, toDisplayString(artistInfo.value.albumSize), 1), createTextVNode(" " + toDisplayString(unref(t)("artist.albums")), 1)])])) : createCommentVNode("", true)])])])])]), createBaseVNode("section", _hoisted_22, [createBaseVNode("div", _hoisted_23, [createBaseVNode("div", _hoisted_24, [createBaseVNode("button", {
                ...
                }, null, -1)), createBaseVNode("span", _hoisted_25, toDisplayString(unref(t)("comp.musicList.playAll")), 1)]), createBaseVNode("button", {
                  ...
                  class: "iconfont icon-add text-lg"
                }, null, -1)), createBaseVNode("span", _hoisted_26, toDisplayString(unref(t)("comp.musicList.addToPlaylist")), 1)])]), createBaseVNode("div", _hoisted_27, [activeTab.value === "songs" ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  class: normalizeClass(["action-btn w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-105 active:scale-95", isSearchVisible.value ? "bg-primary/10 dark:bg-primary/20 text-primary" : "bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700"]),
                ...
                }, null, 2)], 2)) : createCommentVNode("", true), activeTab.value === "songs" && !unref(isMobile) ? (openBlock(), createElementBlock("button", {
                  key: 1,
                ...
                }, null, 2)], 8, _hoisted_28)) : createCommentVNode("", true)])]), createVNode(Transition, {
                  name: "search-slide"
                }, {
                  default: withCtx(() => [isSearchVisible.value && activeTab.value === "songs" ? (openBlock(), createElementBlock("div", _hoisted_29, [createBaseVNode("div", _hoisted_30, [_cache[14] || (_cache[14] = createBaseVNode("i", {
                    class: "iconfont icon-search text-neutral-400 dark:text-neutral-500 ml-4"
                  ...
                  }, null, 40, _hoisted_31), [[vModelText, searchKeyword.value]]), searchKeyword.value ? (openBlock(), createElementBlock("button", {
                    key: 0,
                    ...
                    class: "iconfont icon-close text-sm"
                  }, null, -1)]))])) : createCommentVNode("", true)])])) : createCommentVNode("", true)]),
                  _: 1
                })]), createBaseVNode("section", _hoisted_32, [createBaseVNode("div", _hoisted_33, [(openBlock(true), createElementBlock(Fragment, null, renderList(tabs.value, tab => {
                  return openBlock(), createElementBlock("button", {
                    key: tab.value,
                    class: normalizeClass(["tab-item relative px-4 md:px-6 py-2 md:py-2.5 rounded-lg text-sm font-medium transition-all duration-200", activeTab.value === tab.value ? "text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-300"]),
                    onClick: $event => activeTab.value = tab.value
                  }, [createBaseVNode("span", _hoisted_35, toDisplayString(tab.label), 1), createVNode(Transition, {
                    name: "tab-indicator"
                  }, {
                    default: withCtx(() => [activeTab.value === tab.value ? (openBlock(), createElementBlock("div", _hoisted_36)) : createCommentVNode("", true)]),
                    _: 2
                  }, 1024)], 10, _hoisted_34);
                }), 128))])]), createBaseVNode("section", _hoisted_37, [withDirectives(createBaseVNode("div", _hoisted_38, [filteredSongs.value.length === 0 && searchKeyword.value ? (openBlock(), createElementBlock("div", _hoisted_39, [_cache[15] || (_cache[15] = createBaseVNode("i", {
                  class: "iconfont icon-search text-5xl text-neutral-300 dark:text-neutral-600 mb-4"
                }, null, -1)), createBaseVNode("p", _hoisted_40, toDisplayString(unref(t)("comp.musicList.noSearchResults")), 1)])) : (openBlock(), createElementBlock("div", {
                  key: 1,
                  class: normalizeClass(["song-list", {
                    "compact-mode": isCompactLayout.value
                  }])
                ...
                }, [songLoading.value ? (openBlock(), createElementBlock("div", _hoisted_41, [_cache[16] || (_cache[16] = createBaseVNode("div", {
                  class: "w-5 h-5 border-2 border-primary/30 border-t-primary rounded-full animate-spin"
                }, null, -1)), createBaseVNode("span", _hoisted_42, toDisplayString(unref(t)("common.loading") || "Loading..."), 1)])) : !songPage.value.hasMore && songs.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_43, " — " + toDisplayString(unref(t)("common.noMore") || "No more") + " — ", 1)) : createCommentVNode("", true)], 512)], 512), [[vShow, activeTab.value === "songs"]]), withDirectives(createBaseVNode("div", _hoisted_44, [albums.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_45, [(openBlock(true), createElementBlock(Fragment, null, renderList(albums.value, (album, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: album.id,
                  ...
                  }, [createBaseVNode("div", _hoisted_47, [createBaseVNode("img", {
                    src: unref(getImgUrl)(album.picUrl, "500y500"),
                    alt: album.name,
                    class: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105",
                    loading: "lazy"
                  }, null, 8, _hoisted_48), _cache[17] || (_cache[17] = createBaseVNode("div", {
                    ...
                    class: "iconfont icon-playfill text-xl text-neutral-900 ml-0.5"
                  })])], -1))]), createBaseVNode("div", _hoisted_49, [createBaseVNode("h3", _hoisted_50, toDisplayString(album.name), 1), createBaseVNode("p", _hoisted_51, toDisplayString(formatPublishTime(album.publishTime)), 1)])], 12, _hoisted_46);
                }), 128))])) : createCommentVNode("", true), createBaseVNode("div", {
                  ref_key: "albumsLoadMoreRef",
                  ref: albumsLoadMoreRef,
                  class: "load-more-trigger py-8"
                }, [albumLoading.value ? (openBlock(), createElementBlock("div", _hoisted_52, [_cache[18] || (_cache[18] = createBaseVNode("div", {
                  class: "w-5 h-5 border-2 border-primary/30 border-t-primary rounded-full animate-spin"
                }, null, -1)), createBaseVNode("span", _hoisted_53, toDisplayString(unref(t)("common.loading") || "Loading..."), 1)])) : !albumPage.value.hasMore && albums.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_54, " — " + toDisplayString(unref(t)("common.noMore") || "No more") + " — ", 1)) : createCommentVNode("", true)], 512)], 512), [[vShow, activeTab.value === "albums"]]), withDirectives(createBaseVNode("div", _hoisted_55, [createBaseVNode("div", _hoisted_56, [createBaseVNode("h2", _hoisted_57, toDisplayString(unref(t)("artist.description")), 1), artistInfo.value.briefDesc ? (openBlock(), createElementBlock("div", _hoisted_58, [createBaseVNode("p", _hoisted_59, toDisplayString(artistInfo.value.briefDesc), 1)])) : (openBlock(), createElementBlock("div", _hoisted_60, [_cache[19] || (_cache[19] = createBaseVNode("i", {
                  class: "iconfont icon-info text-5xl mb-4 opacity-50"
                }, null, -1)), createBaseVNode("p", null, toDisplayString(unref(t)("common.noData") || "No description available"), 1)]))])], 512), [[vShow, activeTab.value === "about"]])])])) : (openBlock(), createElementBlock("div", _hoisted_61, [_cache[20] || (_cache[20] = createBaseVNode("i", {
                  class: "iconfont icon-user text-6xl mb-4 opacity-30"
                }, null, -1)), createBaseVNode("p", null, toDisplayString(unref(t)("common.noData") || "Artist not found"), 1)]))])]),
                _: 1
              }, 512), createVNode(PlayBottom)]);
            };
          }
        });
        ...
        const detail = exports("default", /* @__PURE__ */_export_sfc(_sfc_main, [["__scopeId", "data-v-2be28c1d"]]));
      }
    };
  });
})();
