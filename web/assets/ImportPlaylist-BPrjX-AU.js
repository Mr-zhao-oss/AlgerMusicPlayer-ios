import { bl as request, d as defineComponent, a5 as useI18n, bt as useMessage, aq as onMounted, ar as onUnmounted, a7 as openBlock, a8 as createElementBlock, ab as createBaseVNode, b7 as createTextVNode, ac as toDisplayString, ad as unref, ak as createVNode, as as withCtx, ae as Fragment, af as renderList, aa as normalizeClass, ag as normalizeStyle, P as withDirectives, aj as vModelText, ah as createCommentVNode, a6 as vShow, be as Scrollbar, A as ref, z as computed, ap as _export_sfc } from "./index-BMNXZoHW.js";
...
const _hoisted_1 = { class: "h-full w-full bg-gray-50 dark:bg-black transition-colors duration-500 overflow-hidden flex flex-col relative" };
const _hoisted_2 = { class: "flex-shrink-0 z-10 page-padding pt-8 pb-4 relative" };
const _hoisted_3 = { class: "max-w-5xl mx-auto w-full flex items-end justify-between" };
const _hoisted_4 = { class: "text-3xl font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-3" };
const _hoisted_5 = { class: "text-base text-gray-500 dark:text-gray-400 ml-13" };
const _hoisted_6 = { class: "w-full max-w-5xl mx-auto p-6 pb-24" };
const _hoisted_7 = { class: "flex justify-center mb-8" };
const _hoisted_8 = { class: "bg-white dark:bg-white/5 p-1.5 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 flex gap-1 relative" };
const _hoisted_9 = ["onClick"];
const _hoisted_10 = { class: "grid grid-cols-1 lg:grid-cols-3 gap-8 items-start" };
const _hoisted_11 = { class: "lg:col-span-2 space-y-6" };
const _hoisted_12 = { class: "bg-white dark:bg-neutral-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none overflow-hidden p-1 transition-all duration-300" };
const _hoisted_13 = {
  key: 0,
...
const _hoisted_19 = { class: "flex items-center gap-2 text-xs text-gray-400 px-2" };
const _hoisted_20 = {
  key: 2,
  class: "p-6 space-y-6 animate-fade-in"
};
const _hoisted_21 = { class: "space-y-3" };
const _hoisted_22 = { class: "w-6 text-center text-xs text-gray-300 font-mono" };
...
const _hoisted_27 = { class: "bg-blue-50/50 dark:bg-blue-900/10 rounded-2xl p-5 border border-blue-100 dark:border-blue-900/20" };
const _hoisted_28 = { class: "flex gap-3" };
const _hoisted_29 = { class: "text-sm text-gray-600 dark:text-gray-400 space-y-1" };
const _hoisted_30 = { class: "font-medium text-gray-900 dark:text-gray-200 mb-1" };
const _hoisted_31 = { class: "list-disc list-inside opacity-80 space-y-1" };
...
const _hoisted_38 = { class: "bg-white dark:bg-neutral-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none p-6" };
const _hoisted_39 = { class: "font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2" };
const _hoisted_40 = { class: "space-y-4" };
...
const _hoisted_44 = { class: "font-medium text-sm" };
const _hoisted_45 = { class: "ri-check-line text-white text-xs" };
...
const _hoisted_51 = { class: "bg-white dark:bg-neutral-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none p-6" };
const _hoisted_52 = { class: "flex items-center justify-between mb-4" };
const _hoisted_53 = { class: "font-bold text-gray-900 dark:text-white flex items-center gap-2" };
const _hoisted_54 = { class: "relative pt-2" };
const _hoisted_55 = { class: "flex items-center gap-4 mb-4" };
const _hoisted_56 = {
  key: 0,
...
const _hoisted_59 = { class: "font-bold text-lg text-gray-900 dark:text-white" };
const _hoisted_60 = { class: "text-xs text-gray-400 font-mono" };
const _hoisted_61 = {
  key: 0,
  class: "bg-green-50 dark:bg-green-900/10 rounded-xl p-3 text-green-700 dark:text-green-400 text-sm flex justify-between"
};
const _hoisted_62 = { class: "font-bold" };
const _hoisted_63 = {
  key: 1,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tabIndicatorStyle = computed(() => {
      ...
      return {
        left: "calc(".concat(100 / 3 * index, "% + 6px)"),
        width: "calc(".concat(100 / 3, "% - 12px)")
      };
    });
    ...
    const checkTaskStatus = async () => {
      ...
      try {
        ...
        if (res.data.code === 200 && ((_a = res.data.data.tasks) == null ? void 0 : _a.length) > 0) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[12] || (_cache[12] = createBaseVNode("div", { class: "absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-primary/5 to-transparent pointer-events-none" }, null, -1)),
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", null, [
              createBaseVNode("h2", _hoisted_4, [
                _cache[3] || (_cache[3] = createBaseVNode("div", { class: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary" }, [
                  createBaseVNode("i", { class: "ri-import-fill text-xl" })
                ], -1)),
                createTextVNode(" " + toDisplayString(unref(t)("comp.playlist.import.title")), 1)
              ]),
              createBaseVNode("p", _hoisted_5, toDisplayString(unref(t)("comp.playlist.import.description")), 1)
            ])
          ])
        ]),
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(tabs.value, (tab) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      class: normalizeClass([
                        "relative z-10 px-6 py-2.5 rounded-xl text-sm font-medium cursor-pointer transition-all duration-300 flex items-center gap-2",
                        currentTab.value === tab.id ? "text-white" : "text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200"
                      ]),
              ...
              createBaseVNode("div", _hoisted_10, [
                createBaseVNode("div", _hoisted_11, [
                  createBaseVNode("div", _hoisted_12, [
                    currentTab.value === "link" ? (openBlock(), createElementBlock("div", _hoisted_13, [
                      createBaseVNode("div", _hoisted_14, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(linkInputs.value, (link, index) => {
                          return openBlock(), createElementBlock("div", {
                            ...
                            linkInputs.value.length > 1 ? (openBlock(), createElementBlock("button", {
                              key: 0,
                        ...
                        createBaseVNode("button", {
                          ...
                          _cache[5] || (_cache[5] = createBaseVNode("i", { class: "ri-add-line text-lg" }, null, -1)),
                          createTextVNode(" " + toDisplayString(unref(t)("comp.playlist.import.addLinkButton")), 1)
                        ])
                      ])
                    ])) : createCommentVNode("", true),
                    currentTab.value === "text" ? (openBlock(), createElementBlock("div", _hoisted_17, [
                      ...
                      createBaseVNode("div", _hoisted_19, [
                        _cache[6] || (_cache[6] = createBaseVNode("i", { class: "ri-information-line" }, null, -1)),
                        createTextVNode(" " + toDisplayString(unref(t)("comp.playlist.import.textFormat")), 1)
                      ])
                    ])) : createCommentVNode("", true),
                    currentTab.value === "local" ? (openBlock(), createElementBlock("div", _hoisted_20, [
                      createBaseVNode("div", _hoisted_21, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(localMetadata.value, (item, index) => {
                          return openBlock(), createElementBlock("div", {
                            ...
                            createBaseVNode("div", _hoisted_22, toDisplayString(index + 1), 1),
                            withDirectives(createBaseVNode("input", {
                            ...
                            withDirectives(createBaseVNode("input", {
                              ...
                              [vModelText, item.album]
                            ]),
                            localMetadata.value.length > 1 ? (openBlock(), createElementBlock("button", {
                              key: 0,
                        ...
                        createBaseVNode("button", {
                          ...
                          _cache[8] || (_cache[8] = createBaseVNode("i", { class: "ri-add-line" }, null, -1)),
                  ...
                  createBaseVNode("div", _hoisted_27, [
                    createBaseVNode("div", _hoisted_28, [
                      _cache[9] || (_cache[9] = createBaseVNode("div", { class: "mt-0.5 text-blue-500" }, [
                        createBaseVNode("i", { class: "ri-lightbulb-flash-line text-lg" })
                      ], -1)),
                      createBaseVNode("div", _hoisted_29, [
                        createBaseVNode("div", _hoisted_30, toDisplayString(unref(t)("comp.playlist.import.linkTips")), 1),
                        createBaseVNode("ul", _hoisted_31, [
                          currentTab.value === "link" ? (openBlock(), createElementBlock("li", _hoisted_32, toDisplayString(unref(t)("comp.playlist.import.linkTip1")), 1)) : createCommentVNode("", true),
                          currentTab.value === "link" ? (openBlock(), createElementBlock("li", _hoisted_33, toDisplayString(unref(t)("comp.playlist.import.linkTip2")), 1)) : createCommentVNode("", true),
                          currentTab.value === "link" ? (openBlock(), createElementBlock("li", _hoisted_34, toDisplayString(unref(t)("comp.playlist.import.linkTip3")), 1)) : createCommentVNode("", true),
                          currentTab.value === "text" ? (openBlock(), createElementBlock("li", _hoisted_35, toDisplayString(unref(t)("comp.playlist.import.textTips")), 1)) : createCommentVNode("", true),
                          currentTab.value === "local" ? (openBlock(), createElementBlock("li", _hoisted_36, toDisplayString(unref(t)("comp.playlist.import.localTips")), 1)) : createCommentVNode("", true)
                        ])
                      ])
                    ])
                  ])
                ...
                createBaseVNode("div", _hoisted_37, [
                  createBaseVNode("div", _hoisted_38, [
                    createBaseVNode("h3", _hoisted_39, [
                      _cache[10] || (_cache[10] = createBaseVNode("i", { class: "ri-settings-4-line text-primary" }, null, -1)),
                      createTextVNode(" " + toDisplayString(unref(t)("comp.playlist.import.options")), 1)
                    ]),
                    createBaseVNode("div", _hoisted_40, [
                      createBaseVNode("div", {
                        class: normalizeClass([
                          "flex items-center justify-between p-4 rounded-2xl cursor-pointer transition-all border-2",
                          importToStarPlaylist.value ? "bg-primary/5 border-primary/50" : "bg-gray-50 dark:bg-white/5 border-transparent hover:bg-gray-100 dark:hover:bg-white/10"
                        ]),
                        ...
                        createBaseVNode("div", _hoisted_41, [
                          createBaseVNode("div", {
                            ...
                            importToStarPlaylist.value ? (openBlock(), createElementBlock("i", _hoisted_42)) : (openBlock(), createElementBlock("i", _hoisted_43))
                          ], 2),
                          createBaseVNode("span", _hoisted_44, toDisplayString(unref(t)("comp.playlist.import.importToStarPlaylist")), 1)
                        ]),
                        createBaseVNode("div", {
                          class: normalizeClass([
                            "w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors",
                            importToStarPlaylist.value ? "border-primary bg-primary" : "border-gray-300 dark:border-gray-600"
                          ])
                        }, [
                          withDirectives(createBaseVNode("i", _hoisted_45, null, 512), [
                            [vShow, importToStarPlaylist.value]
                          ])
                        ], 2)
                      ], 2),
                      createBaseVNode("div", {
                        class: normalizeClass(["relative group", { "opacity-50 pointer-events-none": importToStarPlaylist.value }])
                      }, [
                        _cache[11] || (_cache[11] = createBaseVNode("div", { class: "absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none" }, [
                          createBaseVNode("i", { class: "ri-play-list-line text-gray-400" })
                        ], -1)),
                        withDirectives(createBaseVNode("input", {
                    ...
                    createBaseVNode("button", {
                      ...
                      importing.value ? (openBlock(), createElementBlock("i", _hoisted_48)) : (openBlock(), createElementBlock("i", _hoisted_49)),
                      createTextVNode(" " + toDisplayString(importing.value ? unref(t)("comp.playlist.import.statusProcessing") : unref(t)("comp.playlist.import.importButton")), 1)
                    ], 8, _hoisted_47)
                  ]),
                  taskId.value ? (openBlock(), createElementBlock("div", _hoisted_50, [
                    createBaseVNode("div", _hoisted_51, [
                      createBaseVNode("div", _hoisted_52, [
                        createBaseVNode("h3", _hoisted_53, toDisplayString(unref(t)("comp.playlist.import.importStatus")), 1),
                        createBaseVNode("button", {
                          class: "text-xs text-primary hover:underline",
                          onClick: refreshStatus
                        }, toDisplayString(unref(t)("comp.playlist.import.refresh")), 1)
                      ]),
                      createBaseVNode("div", _hoisted_54, [
                        createBaseVNode("div", _hoisted_55, [
                          createBaseVNode("div", {
                            ...
                            taskStatus.value === "processing" || taskStatus.value === "pending" ? (openBlock(), createElementBlock("i", _hoisted_56)) : taskStatus.value === "success" ? (openBlock(), createElementBlock("i", _hoisted_57)) : taskStatus.value === "failed" ? (openBlock(), createElementBlock("i", _hoisted_58)) : createCommentVNode("", true)
                          ], 2),
                          createBaseVNode("div", null, [
                            createBaseVNode("div", _hoisted_59, toDisplayString(getStatusText(taskStatus.value)), 1),
                            createBaseVNode("div", _hoisted_60, toDisplayString(taskId.value), 1)
                          ])
                        ]),
                        taskStatus.value === "success" ? (openBlock(), createElementBlock("div", _hoisted_61, [
                          createBaseVNode("span", null, toDisplayString(unref(t)("comp.playlist.import.successCount")), 1),
                          createBaseVNode("span", _hoisted_62, toDisplayString(successCount.value), 1)
                        ])) : createCommentVNode("", true),
                        taskStatus.value === "failed" ? (openBlock(), createElementBlock("div", _hoisted_63, toDisplayString(failReason.value), 1)) : createCommentVNode("", true)
                      ])
                    ])
                  ])) : createCommentVNode("", true)
                ])
...
const ImportPlaylist = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d854ba5"]]);
export {
