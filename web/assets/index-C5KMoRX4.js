import { d as defineComponent, a5 as useI18n, bb as usePlayerStore, dj as useDownload, aq as onMounted, Y as watch, aU as useRouter, a8 as createElementBlock, ab as createBaseVNode, ac as toDisplayString, ad as unref, aW as isElectron, ae as Fragment, af as renderList, aa as normalizeClass, b7 as createTextVNode, ak as createVNode, as as withCtx, d9 as __unplugin_components_0, ah as createCommentVNode, bv as setAnimationClass, a7 as openBlock, aY as createBlock, bd as _sfc_main$1, ag as normalizeStyle, a1 as Button, be as Scrollbar, bI as PlayBottom, z as computed, A as ref, bw as getMusicDetail, bp as setAnimationDelay, ap as _export_sfc } from "./index-BMNXZoHW.js";
const _hoisted_1 = {
  key: 0,
  class: "favorite-page h-full flex flex-col"
};
const _hoisted_2 = { class: "flex items-center gap-4" };
const _hoisted_3 = { class: "text-2xl font-bold text-gray-900 dark:text-white" };
const _hoisted_4 = { class: "text-sm text-gray-500 dark:text-gray-400 mt-0.5" };
const _hoisted_5 = {
  key: 0,
  class: "flex items-center gap-3"
};
const _hoisted_6 = { class: "flex items-center bg-gray-100 dark:bg-neutral-800 rounded-full p-1 h-9" };
  ...
  setup(__props) {
    ...
    const getFavoriteSongs = async () => {
      ...
      try {
        ...
        console.log("最终歌曲列表: ".concat(newSongs.length, "首"));
      ...
      return (__props.isComponent ? favoriteSongs.value.length : true) ? (openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", null, [
              createBaseVNode("h2", _hoisted_3, toDisplayString(unref(t)("favorite.title")), 1),
              createBaseVNode("p", _hoisted_4, toDisplayString(unref(t)("favorite.count", { count: favoriteList.value.length })), 1)
            ])
          ]),
          !__props.isComponent && unref(isElectron) ? (openBlock(), createElementBlock("div", _hoisted_5, [
            !isSelecting.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              createBaseVNode("div", _hoisted_6, [
                (openBlock(), createElementBlock(Fragment, null, renderList([true, false], (isDesc) => {
                  return createBaseVNode("button", {
                    key: String(isDesc),
                    class: normalizeClass([
                      "px-3 h-full rounded-full text-xs font-medium transition-all duration-300 flex items-center gap-1",
                      isDescending.value === isDesc ? "bg-white dark:bg-neutral-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"
                    ]),
                    ...
                    createTextVNode(" " + toDisplayString(isDesc ? unref(t)("favorite.descending") : unref(t)("favorite.ascending")), 1)
                  ], 10, _hoisted_7);
                }), 64))
              ]),
              createBaseVNode("button", {
                ...
                _cache[0] || (_cache[0] = createBaseVNode("i", { class: "ri-checkbox-multiple-line text-sm" }, null, -1)),
              ...
              createVNode(_component_n_checkbox, {
                ...
                default: withCtx(() => [
                  createBaseVNode("span", _hoisted_9, toDisplayString(unref(t)("common.selectAll")), 1)
                ]),
                _: 1
              }, 8, ["checked", "indeterminate"]),
              _cache[2] || (_cache[2] = createBaseVNode("div", { class: "h-3 w-px bg-gray-200 dark:bg-neutral-700 mx-1" }, null, -1)),
              createBaseVNode("div", _hoisted_10, [
                createBaseVNode("button", {
                  ...
                  _cache[1] || (_cache[1] = createBaseVNode("i", { class: "ri-download-line" }, null, -1)),
        ...
        createBaseVNode("div", {
          ...
          createVNode(_component_n_scrollbar, {
            ...
            default: withCtx(() => [
              favoriteList.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_12, [
                _cache[3] || (_cache[3] = createBaseVNode("div", { class: "w-24 h-24 rounded-full bg-gray-100 dark:bg-neutral-800 flex items-center justify-center mb-4" }, [
                  createBaseVNode("i", { class: "ri-heart-line text-4xl text-gray-300 dark:text-gray-600" })
                ], -1)),
                createBaseVNode("p", null, toDisplayString(unref(t)("favorite.emptyTip")), 1)
              ])) : (openBlock(), createElementBlock("div", {
                key: 1,
                class: normalizeClass(["space-y-1 pb-24", { "max-w-[400px]": __props.isComponent }])
              }, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(favoriteSongs.value, (song, index) => {
                  return openBlock(), createBlock(_sfc_main$1, {
                    ...
                    item: song,
                    favorite: false,
                    class: normalizeClass(["rounded-xl hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors", [
                      unref(setAnimationClass)("animate__bounceInLeft"),
                ...
                __props.isComponent ? (openBlock(), createElementBlock("div", _hoisted_13, [
                  createVNode(_component_n_button, {
                    ...
                    default: withCtx(() => [
                      ...
                      _cache[4] || (_cache[4] = createBaseVNode("i", { class: "ri-arrow-right-s-line ml-1" }, null, -1))
                    ]),
                    _: 1
                  })
                ])) : createCommentVNode("", true),
                ...
                noMore.value ? (openBlock(), createElementBlock("div", _hoisted_15, toDisplayString(unref(t)("common.noMore")), 1)) : createCommentVNode("", true)
              ], 2))
            ]),
            _: 1
          }, 512),
...
const Favorite = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-83e96eec"]]);
export {
  Favorite as default
};
