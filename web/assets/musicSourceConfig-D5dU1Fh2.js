import { d as defineComponent, h, e1 as isBrowser, cx as flatten, e2 as Comment, u as useConfig, U as useTheme, i as useRtl, z as computed, e3 as spaceLight, a4 as createKey, e4 as getGap, ca as depx, a as c, c as cB, c3 as resolveWrappedSlot, S as useLocale, R as useFormItem, A as ref, X as useMergedState, c1 as useMemo, Y as watch, c6 as resolveSlot, c2 as NBaseIcon, e5 as XButton, a0 as call, a2 as nextTick, B as on, e6 as inputNumberLight, r as rgba, a3 as toRef, cH as useSettingsStore } from "./index-BMNXZoHW.js";
...
const __unplugin_components_2 = defineComponent({
  ...
  render() {
    ...
    const horizontalMargin = "".concat(margin.horizontal, "px");
    const semiHorizontalMargin = "".concat(margin.horizontal / 2, "px");
    const verticalMargin = "".concat(margin.vertical, "px");
    const semiVerticalMargin = "".concat(margin.vertical / 2, "px");
    const lastIndex = children.length - 1;
    const isJustifySpace = justify.startsWith("space-");
    return h("div", {
      role: "none",
      class: ["".concat(mergedClsPrefix, "-space"), rtlEnabled && "".concat(mergedClsPrefix, "-space--rtl")],
      style: {
        ...
        justifyContent: ["start", "end"].includes(justify) ? "flex-".concat(justify) : justify,
        flexWrap: !wrap || vertical ? "nowrap" : "wrap",
        marginTop: useGap || vertical ? "" : "-".concat(semiVerticalMargin),
        marginBottom: useGap || vertical ? "" : "-".concat(semiVerticalMargin),
        alignItems: align,
        gap: useGap ? "".concat(margin.vertical, "px ").concat(margin.horizontal, "px") : ""
      }
...
const __unplugin_components_1 = defineComponent({
  ...
  setup(props) {
    ...
    return Object.assign(Object.assign({}, exposedMethods), {
      ...
      buttonThemeOverrides: computed(() => {
        ...
        return {
          textColorTextDisabled: "rgb(".concat(r, ", ").concat(g, ", ").concat(b, ")"),
          opacityDisabled: "".concat(a)
        };
      })
    });
  },
  render() {
    ...
    return h("div", {
      class: ["".concat(mergedClsPrefix, "-input-number"), this.rtlEnabled && "".concat(mergedClsPrefix, "-input-number--rtl")]
      ...
      prefix: () => {
        ...
        return this.showButton && this.buttonPlacement === "both" ? [renderMinusButton(), resolveWrappedSlot($slots.prefix, (children) => {
          if (children) {
            return h("span", {
              class: "".concat(mergedClsPrefix, "-input-number-prefix")
            }, children);
          }
          return null;
      ...
      suffix: () => {
        ...
        return this.showButton ? [resolveWrappedSlot($slots.suffix, (children) => {
          if (children) {
            return h("span", {
              class: "".concat(mergedClsPrefix, "-input-number-suffix")
            }, children);
          }
          return null;
  ...
  const allSources = computed(() => {
    return MUSIC_SOURCE_REGISTRY.map((source) => {
      ...
      if (source.key === "lxMusic") {
        available = ((_b = (_a = settingsStore.setData.lxMusicScripts) == null ? void 0 : _a.length) != null ? _b : 0) > 0 && Boolean(settingsStore.setData.activeLxMusicApiId);
