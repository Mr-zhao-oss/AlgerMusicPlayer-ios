;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './Add-legacy-CnU6_mh8.js'], function (exports, module) {
    'use strict';

    var defineComponent, h, useSsrAdapter, cssrAnchorMetaName, ref, c, isSymbol, isObject, root, createInjectionKey, mergeProps, Fragment, NBaseIcon, render, NBaseClose, inject, computed, omit, cB, cM, c$1, cE, cNotM, flatten, resolveWrappedSlot, VResizeObserver, useConfig, useTheme, useMergedState, watch, onMounted, onFontsReady, watchEffect, useThemeClass, useCompitable, depx, withDirectives, vShow, TransitionGroup, cloneVNode, tabsLight, nextTick, createKey, getMargin, provide, toRef, call, AddIcon;
    return {
      setters: [module => {
        ...
        VResizeObserver = module.dG;
        useConfig = module.u;
        useTheme = module.U;
        useMergedState = module.X;
        watch = module.Y;
        onMounted = module.aq;
        onFontsReady = module.dZ;
      ...
      execute: function () {
        ...
        const __unplugin_components_2 = exports("_", defineComponent({
          __TAB__: true,
          inheritAttrs: false,
          name: 'Tab',
          props: tabProps,
...
`, [cM('segment-type', [cB('tabs-rail', [c$1('&.transition-disabled', [cB('tabs-capsule', `
 ...
 `)])])])]);
        ...
        const __unplugin_components_3 = exports("a", defineComponent({
          name: "Tabs",
          props: tabsProps,
          slots: Object,
          setup(props, {
