import { d as defineComponent, a5 as useI18n, bt as useMessage, aq as onMounted, aW as isElectron, bG as onBeforeUnmount, a8 as createElementBlock, aa as normalizeClass, ad as unref, bv as setAnimationClass, ab as createBaseVNode, ac as toDisplayString, P as withDirectives, aj as vModelText, bP as isRef, ak as createVNode, a1 as Button, as as withCtx, b7 as createTextVNode, aY as createBlock, ah as createCommentVNode, A as ref, bQ as getUserDetail, a7 as openBlock, ap as _export_sfc, ar as onUnmounted, bj as __unplugin_components_2, bR as getQrKey, bS as createQr, bT as checkQr, ai as withKeys, bU as loginByUid, aU as useRouter, b5 as useUserStore, ae as Fragment, af as renderList, T as Transition, z as computed, bV as loginByCellphone } from "./index-BMNXZoHW.js";
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const handleLogin = async () => {
      ...
      try {
        ...
        if (((_a = error.response) == null ? void 0 : _a.status) === 404 || ((_c = (_b = error.response) == null ? void 0 : _b.data) == null ? void 0 : _c.code) === 404) {
...
const LoginComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f4c74bb0"]]);
export {
