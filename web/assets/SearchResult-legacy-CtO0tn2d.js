;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './SearchItem-legacy-CVv33wxW.js', './useScrollTitle-legacy-nHgisOEQ.js', './MusicListNavigator-legacy-0pJHpxez.js', './music-legacy-CGPq9ktk.js', './MvPlayer-legacy-CFWnKFW4.js', './index-legacy-BqM8rotH.js'], function (exports, module) {
    'use strict';

    var defineComponent, useI18n, useRoute, useRouter, usePlayerStore, useSearchStore, useDownload, ref, isMobile, onMounted, watch, openBlock, createElementBlock, createVNode, withCtx, createBaseVNode, toDisplayString, unref, Fragment, renderList, normalizeClass, SEARCH_TYPE, isElectron, createCommentVNode, __unplugin_components_0, createTextVNode, __unplugin_components_2, normalizeStyle, calculateAnimationDelay, _sfc_main$1, Scrollbar, PlayBottom, computed, getSearch, useDateFormat, SEARCH_TYPES, _export_sfc, SearchItem, useScrollTitle;
    return {
      setters: [module => {
      ...
      execute: function () {
        ...
        __vite_style__.textContent = ".search-result-page[data-v-29584c52] {\n  position: relative;\n}\n.animate-item[data-v-29584c52] {\n  animation: fadeInUp-29584c52 0.6s cubic-bezier(0.16, 1, 0.3, 1) backwards;\n}\n@keyframes fadeInUp-29584c52 {\nfrom {\n    opacity: 0;\n    transform: translateY(20px);\n}\nto {\n    opacity: 1;\n    transform: translateY(0);\n}\n}\n.no-scrollbar[data-v-29584c52] {\n  -ms-overflow-style: none;\n  scrollbar-width: none;\n}\n.no-scrollbar[data-v-29584c52]::-webkit-scrollbar {\n  display: none;\n}/*$vite$:1*/";
        document.head.appendChild(__vite_style__);
        const _hoisted_1 = {
          class: "search-result-page h-full w-full bg-white dark:bg-black transition-colors duration-500"
        };
        const _hoisted_2 = {
          class: "search-result-content pb-32"
        };
        const _hoisted_3 = {
          class: "header-section page-padding-x pt-8 pb-6"
        };
        const _hoisted_4 = {
        ...
        const _hoisted_15 = {
          class: "results-section page-padding-x mt-6"
        };
        const _hoisted_16 = {
          key: 0,
        ...
        const _sfc_main = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            const isAllSelected = computed(() => searchDetail.value?.songs?.length > 0 && selectedSongs.value.length === searchDetail.value.songs.length);
            const isIndeterminate = computed(() => selectedSongs.value.length > 0 && selectedSongs.value.length < (searchDetail.value?.songs?.length || 0));
            ...
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_n_scrollbar, {
                ...
                default: withCtx(() => [createBaseVNode("div", _hoisted_2, [createBaseVNode("section", _hoisted_3, [createBaseVNode("div", _hoisted_4, [createBaseVNode("div", null, [createBaseVNode("h1", {
                  ref_key: "titleElRef",
                  ref: titleElRef,
                  class: "text-3xl md:text-4xl font-bold tracking-tight text-neutral-900 dark:text-white mb-1"
                }, toDisplayString(currentKeyword.value), 513), createBaseVNode("p", _hoisted_5, toDisplayString(unref(t)("search.title.searchList")), 1)]), createBaseVNode("div", _hoisted_6, [(openBlock(true), createElementBlock(Fragment, null, renderList(searchTypeOptions.value, type => {
                  return openBlock(), createElementBlock("button", {
                    key: type.key,
                    class: normalizeClass(["px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 whitespace-nowrap", searchType.value === type.key ? "bg-primary text-white shadow-lg shadow-primary/25" : "bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800"]),
                    onClick: $event => handleTypeChange(type.key)
                  }, toDisplayString(type.label), 11, _hoisted_7);
                }), 128))])])]), searchDetail.value?.songs?.length && searchType.value === unref(SEARCH_TYPE).MUSIC ? (openBlock(), createElementBlock("section", _hoisted_8, [createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, [createBaseVNode("button", {
                  ...
                  class: "ri-play-circle-line text-lg"
                }, null, -1)), createBaseVNode("span", null, toDisplayString(unref(t)("search.button.playAll")), 1)]), unref(isElectron) ? (openBlock(), createElementBlock("div", _hoisted_11)) : createCommentVNode("", true), !isSelecting.value && unref(isElectron) ? (openBlock(), createElementBlock("button", {
                  key: 1,
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  onClick: startSelect
                }, [...(_cache[2] || (_cache[2] = [createBaseVNode("i", {
                  class: "ri-checkbox-multiple-line text-lg"
                }, null, -1)]))])) : createCommentVNode("", true), isSelecting.value ? (openBlock(), createElementBlock("div", _hoisted_12, [createVNode(_component_n_checkbox, {
                ...
                })), 1)], 8, _hoisted_13), createBaseVNode("button", {
                  class: "text-xs text-neutral-400 hover:text-neutral-600",
                  onClick: cancelSelect
                }, toDisplayString(unref(t)("common.cancel")), 1)])) : createCommentVNode("", true)]), createBaseVNode("div", _hoisted_14, [!unref(isMobile) ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  onClick: toggleLayout
                }, [createBaseVNode("i", {
                  class: normalizeClass([isCompactLayout.value ? "ri-list-check-2" : "ri-grid-line", "text-lg"])
                }, null, 2)])) : createCommentVNode("", true)])])])) : createCommentVNode("", true), createBaseVNode("section", _hoisted_15, [createVNode(_component_n_spin, {
                  show: searchDetailLoading.value
                }, {
                  default: withCtx(() => [searchDetailLoading.value && !isLoadingMore.value ? (openBlock(), createElementBlock("div", _hoisted_16, [(openBlock(), createElementBlock(Fragment, null, renderList(12, i => {
                    ...
                    key: 1
                  }, [searchType.value === unref(SEARCH_TYPE).MUSIC ? (openBlock(), createElementBlock("div", _hoisted_17, [(openBlock(true), createElementBlock(Fragment, null, renderList(searchDetail.value?.songs, (item, index) => {
                    return openBlock(), createElementBlock("div", {
                      key: item.id,
                      class: "mb-2 animate-item",
                      style: normalizeStyle({
                        animationDelay: unref(calculateAnimationDelay)(index % 30, 0.04)
                      })
                    ...
                    }, null, 8, ["index", "item", "compact", "selectable", "selected"])], 4);
                  }), 128))])) : (openBlock(), createElementBlock("div", _hoisted_18, [searchType.value === unref(SEARCH_TYPE).MV ? (openBlock(), createElementBlock("div", _hoisted_19, [(openBlock(true), createElementBlock(Fragment, null, renderList(searchDetail.value?.mvs, (item, index) => {
                    return openBlock(), createElementBlock("div", {
                      key: item.id,
                      class: "animate-item",
                      style: normalizeStyle({
                    ...
                    }, [createVNode(SearchItem, {
                      item
                    }, null, 8, ["item"])], 4);
                  }), 128))])) : (openBlock(), createElementBlock("div", _hoisted_20, [(openBlock(true), createElementBlock(Fragment, null, renderList(searchDetail.value, (list, key) => {
                    return openBlock(), createElementBlock(Fragment, {
                      key
                    }, [key.toString() !== "songs" && key.toString() !== "djRadios" && key.toString() !== "mvs" ? (openBlock(true), createElementBlock(Fragment, {
                      key: 0
                    ...
                    }), 128)) : createCommentVNode("", true), key.toString() === "djRadios" ? (openBlock(true), createElementBlock(Fragment, {
                      key: 1
                    }, renderList(searchDetail.value.djRadios, (item, index) => {
                      return openBlock(), createElementBlock("div", {
                        key: item.id,
                        class: "animate-item",
                        style: normalizeStyle({
                  ...
                  }), 128))]))])), !searchDetailLoading.value && isResultEmpty.value ? (openBlock(), createElementBlock("div", _hoisted_21, [_cache[5] || (_cache[5] = createBaseVNode("i", {
                    class: "ri-search-line text-6xl mb-4 opacity-20"
                  }, null, -1)), createBaseVNode("p", null, toDisplayString(unref(t)("comp.musicList.noSearchResults")), 1)])) : createCommentVNode("", true), createBaseVNode("div", _hoisted_22, [isLoadingMore.value ? (openBlock(), createElementBlock("div", _hoisted_23, [createVNode(_component_n_spin, {
                    size: "small"
                  }), createBaseVNode("span", _hoisted_24, toDisplayString(unref(t)("search.loading.more")), 1)])) : createCommentVNode("", true), !hasMore.value && !isResultEmpty.value ? (openBlock(), createElementBlock("div", _hoisted_25, [createBaseVNode("span", _hoisted_26, " — " + toDisplayString(unref(t)("search.noMore")) + " — ", 1)])) : createCommentVNode("", true)])], 64))]),
                  _: 1
                }, 8, ["show"])])])]),
                _: 1
        ...
        const SearchResult = exports("default", /* @__PURE__ */_export_sfc(_sfc_main, [["__scopeId", "data-v-29584c52"]]));
      }
    };
  });
})();
