    ...
    return {
      execute: function () {
        ...
        var a = [],
          ...
          i = {};
        function e(n) {
          for (var a = [], u = n.length, i = [], e = 0; u >= e; e++) i.push(true);
          return o(0, n, [], a, i), a;
        }
        function o(n, u, i, e, r) {
          var g = u.length;
          if (n !== g) for (var h = function () {
              var g = u.substring(n, t + 1),
                h = false;
              if (a.some(function (n) {
                return 0 === n.indexOf(g);
              }) && !u[t + 1] && r[t + 1]) {
                if (1 === g.length) i.push(g);else {
                  var l = [];
                  a.forEach(function (n) {
                    0 === n.indexOf(g) && l.push(n);
                  }), i.push(l);
                }
                h = true;
              } else -1 !== a.indexOf(g) && r[t + 1] && (i.push(g), h = true);
              if (h) {
                var c = e.length;
                o(t + 1, u, i, e, r), e.length === c && (r[t + 1] = false), i.pop();
              }
            }, t = n; g > t; t++) h();else e.push(i.join(" "));
        }
        function r(n, a, u, i) {
          if (!n) return false;
          var e = n.split(" ");
          return e.forEach(function (n) {
            n.length > 0 && i && e.push(n.charAt(0));
          }), u ? e.some(function (n) {
        ...
        function h(a, o) {
          if (!a || !o) return false;
          a = a.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, ""), o = function (n) {
            var a = n.replace(/\s+/g, "").toLowerCase();
            return g.some(function (n) {
              return a.includes(n);
            }) && (a = a.replace("ü", "v")), a.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
          }(o);
          var r = a.indexOf(o);
          if (-1 !== r) return [r, r + o.length - 1];
          var h = t(a.split(""), [o.split("")], o);
          if (h) return h;
          var l,
            c,
            f = function (n) {
          ...
          return t(f, i[o] || (c = [], e(l = o).forEach(function (n) {
            var a = n.split(" "),
              u = a.length - 1;
            a[u].indexOf(",") ? a[u].split(",").forEach(function (n) {
              a.splice(u, 1, n), c.push(JSON.parse(JSON.stringify(a)));
            }) : c.push(a);
          }), 0 !== c.length && c[0].length === l.length || c.push(l.split("")), i = n({}, l, c), c), o);
        }
        function t(n, a, u) {
          for (var i = 0; n.length > i; i++) for (var e = 0; a.length > e; e++) {
            var o = a[e],
              g = o.length,
              h = g === u.length,
              t = true,
              ...
              f = 0;
            if (n.length >= g) {
              for (; o.length > l; l++) if (0 === l && " " === n[i + l + c]) c += 1, l -= 1;else if (" " === n[i + l + f]) f += 1, l -= 1;else if (!r(n[i + l + f], o[l], !n[i + l + 1] || !o[l + 1], h)) {
                t = false;
                break;
              }
              if (t) return [i + c, f + i + l - 1];
            }
          }
          return false;
        }
        var l = exports("l", {
          match: function (n) {
            ...
            return Object.keys(n).forEach(function (u) {
              if (i[u] = n[u], a.push(u), e.includes(u)) {
                var r = -1 !== (g = u).indexOf("u") ? g.replace("u", "v") : g.replace("v", "u");
                i[r] = n[u], a.push(r);
              }
              var g;
              if (o.includes(u)) {
              ...
              var a = {};
              for (var u in n) for (var i = n[u], e = 0, o = i.length; o > e; e++) a[i[e]] = a[i[e]] ? a[i[e]] + " " + u : u;
              return a;
            }(i), h;
          }({
            a: "阿啊呵腌嗄吖锕",
