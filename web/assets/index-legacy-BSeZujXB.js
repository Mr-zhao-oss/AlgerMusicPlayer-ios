;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './index-legacy-BCc1NR1U.js', './MusicListNavigator-legacy-0pJHpxez.js', './podcastUtils-legacy-DdknKy-V.js', './music-legacy-CGPq9ktk.js'], function (exports, module) {
    'use strict';

    var defineComponent, createElementBlock, createVNode, __unplugin_components_1, createBaseVNode, __unplugin_components_2, withCtx, createTextVNode, toDisplayString, createCommentVNode, withModifiers, openBlock, useI18n, createBlock, unref, getImgUrl, useMessage, useRouter, usePlayHistoryStore, useUserStore, usePlayerStore, onMounted, watch, Fragment, renderList, normalizeClass, setAnimationClass, Scrollbar, normalizeStyle, setAnimationDelay, _sfc_main$5, isMobile, withDirectives, vShow, ref, getMusicDetail, getRecentSongs, getRecentPlaylists, getRecentAlbums, _export_sfc, Favorite, navigateToMusicList, mapDjProgramToSongResult;
    return {
      setters: [module => {
        ...
        _sfc_main$5 = module.bd;
        isMobile = module.aX;
        withDirectives = module.P;
        vShow = module.a6;
        ref = module.A;
        getMusicDetail = module.bw;
        getRecentSongs = module.bx;
        getRecentPlaylists = module.by;
        getRecentAlbums = module.bz;
        _export_sfc = module.ap;
      }, module => {
        Favorite = module.default;
      }, module => {
      ...
      execute: function () {
        ...
        __vite_style__.textContent = "/* Minimal scoped styles */\n.flex-item[data-v-3b6ccd79] {\n    flex: 1 1 0%;\n    overflow: hidden;\n    border-radius: 1.5rem;\n    border-width: 1px;\n    --tw-border-opacity: 1;\n    border-color: rgb(243 244 246 / var(--tw-border-opacity, 1));\n    --tw-bg-opacity: 1;\n    background-color: rgb(249 250 251 / var(--tw-bg-opacity, 1));\n    transition-property: all;\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n    transition-duration: 300ms\n}\n.flex-item[data-v-3b6ccd79]:is(.dark *) {\n    --tw-border-opacity: 1;\n    border-color: rgb(38 38 38 / var(--tw-border-opacity, 1));\n    background-color: rgb(23 23 23 / 0.5)\n}\n/*$vite$:1*/";
        document.head.appendChild(__vite_style__);
        const _hoisted_1$2 = {
          class: "flex-1 min-w-0"
        };
        const _hoisted_2$1 = {
          class: "text-base text-gray-900 dark:text-white mb-1"
        };
        const _hoisted_3$1 = {
          ...
          setup(__props) {
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", {
                ...
                lazy: "",
                "preview-disabled": ""
              }, null, 8, ["src"]), createBaseVNode("div", _hoisted_1$2, [createBaseVNode("div", _hoisted_2$1, [createVNode(_component_n_ellipsis, {
                "line-clamp": 1
              }, {
                default: withCtx(() => [createTextVNode(toDisplayString(__props.name), 1)]),
                _: 1
              })]), createBaseVNode("div", _hoisted_3$1, toDisplayString(__props.description), 1)]), __props.showCount && __props.count ? (openBlock(), createElementBlock("div", _hoisted_4$1, toDisplayString(__props.count), 1)) : createCommentVNode("", true), __props.showDelete ? (openBlock(), createElementBlock("div", {
                key: 1,
        ...
        const _sfc_main$3 = /* @__PURE__ */defineComponent({
          ...
          setup(__props, {
            ...
            const getDescription = () => {
              ...
              if (props.item.size !== void 0) parts.push(t("common.songCount", {
                count: props.item.size
              }));
        ...
        const _sfc_main$2 = /* @__PURE__ */defineComponent({
          ...
          setup(__props, {
            ...
            const getDescription = () => {
              const parts = [];
              if (props.item.trackCount !== void 0) parts.push(t("user.playlist.trackCount", {
                count: props.item.trackCount
              }));
        ...
        const _hoisted_1$1 = {
          class: "history-page h-full flex flex-col"
        };
        const _hoisted_2 = {
        ...
        const _hoisted_5 = {
          class: "bg-gray-100 dark:bg-neutral-800 p-1 rounded-full inline-flex h-8 md:h-9 items-center overflow-x-auto no-scrollbar max-w-full"
        };
        ...
        const _sfc_main$1 = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            watch(() => [playHistoryStore.musicHistory, playHistoryStore.playlistHistory, playHistoryStore.albumHistory, playHistoryStore.podcastHistory, playHistoryStore.podcastRadioHistory], async () => {
              if (hasLoaded.value) {
                currentPage.value = 1;
                noMore.value = false;
                await loadHistoryData();
            ...
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", _hoisted_1$1, [createBaseVNode("div", {
              ...
              }, [createBaseVNode("div", _hoisted_2, [createBaseVNode("h2", _hoisted_3, toDisplayString(unref(t)("history.title")), 1), createBaseVNode("button", {
              ...
              }, null, -1)), createTextVNode(" " + toDisplayString(unref(t)("history.heatmapTitle")), 1)])]), createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [(openBlock(), createElementBlock(Fragment, null, renderList(["songs", "playlists", "albums", "podcasts"], tab => {
                return createBaseVNode("div", {
                  key: tab,
                  class: normalizeClass(["px-3 md:px-4 h-6 md:h-7 rounded-full text-[11px] md:text-xs font-medium cursor-pointer transition-all duration-300 flex items-center justify-center whitespace-nowrap", currentCategory.value === tab ? "bg-white dark:bg-neutral-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"]),
                  onClick: $event => handleCategoryChange(tab)
                }, toDisplayString(unref(t)(`history.categoryTabs.${tab}`)), 11, _hoisted_6);
              }), 64))]), currentCategory.value !== "podcasts" ? (openBlock(), createElementBlock("div", _hoisted_7, [createBaseVNode("button", {
                class: normalizeClass(["px-3 h-6 md:h-7 rounded-full text-[11px] md:text-xs font-medium transition-all duration-300", currentTab.value === "local" ? "bg-white dark:bg-neutral-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700"]),
                onClick: _cache[0] || (_cache[0] = $event => handleTabChange("local"))
              }, toDisplayString(unref(t)("history.tabs.local")), 3), createBaseVNode("button", {
                class: normalizeClass(["px-3 h-6 md:h-7 rounded-full text-[11px] md:text-xs font-medium transition-all duration-300", currentTab.value === "cloud" ? "bg-white dark:bg-neutral-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700"]),
                onClick: _cache[1] || (_cache[1] = $event => handleTabChange("cloud"))
              }, toDisplayString(unref(t)("history.tabs.cloud")), 3)])) : createCommentVNode("", true)])], 2), createBaseVNode("div", {
                ...
                default: withCtx(() => [createBaseVNode("div", _hoisted_8, [currentCategory.value === "songs" ? (openBlock(true), createElementBlock(Fragment, {
                  key: 0
                }, renderList(displayList.value, (item, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: item.id,
                    ...
                    item,
                    onPlay: handlePlay
                  }, null, 8, ["item"]), !unref(isMobile) ? (openBlock(), createElementBlock(Fragment, {
                    key: 0
                  }, [withDirectives(createBaseVNode("div", {
                    class: "px-4 text-xs text-gray-400 dark:text-gray-600 font-medium min-w-[60px] text-right"
                  }, toDisplayString(unref(t)("history.playCount", {
                    count: item.count
                  })), 513), [[vShow, currentTab.value === "local"]]), withDirectives(createBaseVNode("div", {
                  ...
                  }, null, -1)]))], 8, _hoisted_9), [[vShow, currentTab.value === "local"]])], 64)) : createCommentVNode("", true)], 6);
                }), 128)) : createCommentVNode("", true), currentCategory.value === "playlists" ? (openBlock(true), createElementBlock(Fragment, {
                  key: 1
                }, renderList(displayList.value, (item, index) => {
                ...
                }), 128)) : createCommentVNode("", true), currentCategory.value === "albums" ? (openBlock(true), createElementBlock(Fragment, {
                  key: 2
                }, renderList(displayList.value, (item, index) => {
                ...
                }), 128)) : createCommentVNode("", true), currentCategory.value === "podcasts" ? (openBlock(), createElementBlock(Fragment, {
                  key: 3
                }, [createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [createBaseVNode("button", {
                  class: normalizeClass(["px-3 h-6 rounded-full text-xs font-medium transition-all duration-300", currentPodcastSubTab.value === "episodes" ? "bg-white dark:bg-neutral-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"]),
                  onClick: _cache[2] || (_cache[2] = $event => {
                    currentPodcastSubTab.value = "episodes";
                    loadHistoryData();
                  })
                }, toDisplayString(unref(t)("history.podcastTabs.episodes")), 3), createBaseVNode("button", {
                  class: normalizeClass(["px-3 h-6 rounded-full text-xs font-medium transition-all duration-300", currentPodcastSubTab.value === "radios" ? "bg-white dark:bg-neutral-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"]),
                  onClick: _cache[3] || (_cache[3] = $event => {
                    currentPodcastSubTab.value = "radios";
                    loadHistoryData();
                  })
                }, toDisplayString(unref(t)("history.podcastTabs.radios")), 3)])]), currentPodcastSubTab.value === "episodes" ? (openBlock(), createElementBlock("div", _hoisted_12, [(openBlock(true), createElementBlock(Fragment, null, renderList(displayList.value, (item, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: item.id,
                    class: normalizeClass(["group flex items-center justify-between rounded-xl hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors p-1", unref(setAnimationClass)("animate__bounceInRight")]),
                    style: normalizeStyle(unref(setAnimationDelay)(index, 30))
                  ...
                  }, null, 8, ["item", "onPlay"]), createBaseVNode("div", {
                    class: "w-8 h-8 flex items-center justify-center rounded-full text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 cursor-pointer transition-all opacity-0 group-hover:opacity-100",
                    onClick: $event => handleDelPodcast(item)
                  }, [...(_cache[6] || (_cache[6] = [createBaseVNode("i", {
                    class: "ri-close-line text-lg"
                  }, null, -1)]))], 8, _hoisted_13)], 6);
                }), 128))])) : (openBlock(), createElementBlock("div", _hoisted_14, [(openBlock(true), createElementBlock(Fragment, null, renderList(displayList.value, (item, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: item.id,
                  ...
                  }, null, 8, ["item", "onClick"]), createBaseVNode("div", {
                    ...
                    class: "ri-close-line text-lg"
                  }, null, -1)]))], 8, _hoisted_15)], 6);
                }), 128))]))], 64)) : createCommentVNode("", true), displayList.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("div", _hoisted_16, [_cache[8] || (_cache[8] = createBaseVNode("div", {
                  class: "w-20 h-20 mx-auto rounded-full bg-gray-100 dark:bg-neutral-800 flex items-center justify-center mb-4"
                }, [createBaseVNode("i", {
                  class: "ri-history-line text-3xl text-gray-300 dark:text-gray-600"
                })], -1)), createBaseVNode("p", null, toDisplayString(unref(t)("history.noData")), 1)])) : createCommentVNode("", true), loading.value ? (openBlock(), createElementBlock("div", _hoisted_17, [(openBlock(), createElementBlock(Fragment, null, renderList(8, i => {
                  return createBaseVNode("div", {
                    key: i,
                ...
                }), 64))])) : createCommentVNode("", true), noMore.value && displayList.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString(unref(t)("common.noMore")), 1)) : createCommentVNode("", true)])]),
                _: 1
              }, 512)], 2)]);
            };
          }
        ...
        const _hoisted_1 = {
          class: "flex gap-6 h-full pb-4 page-padding pt-6 bg-white dark:bg-black"
        };
        const _sfc_main = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            return (_ctx, _cache) => {
              return openBlock(), createElementBlock("div", _hoisted_1, [!unref(isMobile) ? (openBlock(), createBlock(Favorite, {
                key: 0,
                class: "flex-item"
              })) : createCommentVNode("", true), createVNode(HistoryList, {
                class: "flex-item"
              })]);
            };
          }
        ...
        const index = exports("default", /* @__PURE__ */_export_sfc(_sfc_main, [["__scopeId", "data-v-3b6ccd79"]]));
      }
    };
  });
})();
