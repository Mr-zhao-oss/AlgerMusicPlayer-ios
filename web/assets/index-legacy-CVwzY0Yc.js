;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './Input-legacy-D1FyU7q2.js', './VirtualList-legacy-nZVZUnH5.js', './VirtualList-legacy-Dp4NcZuw.js'], function (exports, module) {
    'use strict';

    var defineComponent, useI18n, createDiscreteApi, useLocalMusicStore, usePlayerStore, onMounted, createElementBlock, createVNode, withCtx, createBaseVNode, toDisplayString, unref, openBlock, createCommentVNode, normalizeClass, __unplugin_components_2, createTextVNode, _sfc_main$1, Scrollbar, __unplugin_components_5, Fragment, renderList, Button, __unplugin_components_6, ref, computed, filterByKeyword, toSongResult, _export_sfc, __unplugin_components_0, __unplugin_components_1;
    return {
      setters: [module => {
        defineComponent = module.d;
        useI18n = module.a5;
        createDiscreteApi = module.bn;
        useLocalMusicStore = module.bA;
        ...
        ref = module.A;
        computed = module.z;
        filterByKeyword = module.bD;
        toSongResult = module.bE;
      ...
      execute: function () {
        ...
        __vite_style__.textContent = "\n/* 虚拟列表样式 */\n.song-virtual-list[data-v-9cf7cb6c] {\n  width: 100%;\n}\n.song-virtual-list[data-v-9cf7cb6c] .n-virtual-list__scroll {\n  scrollbar-width: thin;\n}\n.song-virtual-list[data-v-9cf7cb6c] .n-virtual-list__scroll::-webkit-scrollbar {\n  width: 6px;\n}\n.song-virtual-list[data-v-9cf7cb6c] .n-virtual-list__scroll::-webkit-scrollbar-thumb {\n  border-radius: 9999px;\n  --tw-bg-opacity: 1;\n  background-color: rgb(212 212 212 / var(--tw-bg-opacity, 1));\n}\n.song-virtual-list[data-v-9cf7cb6c] .n-virtual-list__scroll:is(.dark *)::-webkit-scrollbar-thumb {\n  --tw-bg-opacity: 1;\n  background-color: rgb(64 64 64 / var(--tw-bg-opacity, 1));\n}\n.song-virtual-list[data-v-9cf7cb6c] .n-virtual-list__scroll::-webkit-scrollbar-track {\n  background-color: transparent;\n}\n/*$vite$:1*/";
        document.head.appendChild(__vite_style__);
        const _hoisted_1 = {
          class: "local-music-page h-full w-full bg-white dark:bg-black transition-colors duration-500"
        };
        const _hoisted_2 = {
          class: "local-music-content pb-32"
        };
        const _hoisted_3 = {
          ...
          setup(__props) {
            ...
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_n_scrollbar, {
                ...
                default: withCtx(() => [createBaseVNode("div", _hoisted_2, [createBaseVNode("section", _hoisted_3, [_cache[4] || (_cache[4] = createBaseVNode("div", {
                ...
                })], -1)), createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, [_cache[3] || (_cache[3] = createBaseVNode("div", {
                  ...
                  class: "ri-folder-music-fill text-6xl text-primary opacity-80"
                })])], -1)), createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createBaseVNode("span", _hoisted_8, toDisplayString(unref(t)("localMusic.title")), 1)]), createBaseVNode("h1", _hoisted_9, toDisplayString(unref(t)("localMusic.title")), 1), createBaseVNode("p", _hoisted_10, toDisplayString(unref(t)("localMusic.songCount", {
                  count: unref(localMusicStore).musicList.length
                })), 1)])])])]), createBaseVNode("section", _hoisted_11, [createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [createVNode(_component_n_input, {
                  ...
                  prefix: withCtx(() => [...(_cache[5] || (_cache[5] = [createBaseVNode("i", {
                    class: "ri-search-line text-neutral-400"
                  }, null, -1)]))]),
                  _: 1
                }, 8, ["value", "placeholder"])]), createBaseVNode("div", _hoisted_14, [filteredList.value.length > 0 ? (openBlock(), createElementBlock("button", {
                  key: 0,
                ...
                }, null, -1)), createBaseVNode("span", _hoisted_15, toDisplayString(unref(t)("localMusic.playAll")), 1)])) : createCommentVNode("", true), createBaseVNode("button", {
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  disabled: unref(localMusicStore).scanning,
                  onClick: handleScan
                }, [createBaseVNode("i", {
                  class: normalizeClass(["ri-refresh-line text-lg", {
                    "animate-spin": unref(localMusicStore).scanning
                  }])
                }, null, 2)], 8, _hoisted_16), createBaseVNode("button", {
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  onClick: handleAddFolder
                }, [...(_cache[7] || (_cache[7] = [createBaseVNode("i", {
                  class: "ri-folder-add-line text-lg"
                }, null, -1)]))]), unref(localMusicStore).folderPaths.length > 0 ? (openBlock(), createElementBlock("button", {
                  key: 1,
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  onClick: _cache[1] || (_cache[1] = $event => showFolderManager.value = true)
                }, [...(_cache[8] || (_cache[8] = [createBaseVNode("i", {
                  class: "ri-folder-settings-line text-lg"
                }, null, -1)]))])) : createCommentVNode("", true)])])]), unref(localMusicStore).scanning ? (openBlock(), createElementBlock("section", _hoisted_17, [createBaseVNode("div", _hoisted_18, [createVNode(_component_n_spin, {
                  size: "small"
                }), createBaseVNode("div", null, [createBaseVNode("p", _hoisted_19, toDisplayString(unref(t)("localMusic.scanning")), 1), createBaseVNode("p", _hoisted_20, toDisplayString(unref(t)("localMusic.songCount", {
                  count: unref(localMusicStore).scanProgress
                })), 1)])])])) : createCommentVNode("", true), createBaseVNode("section", _hoisted_21, [!unref(localMusicStore).scanning && filteredList.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_22, [_cache[10] || (_cache[10] = createBaseVNode("i", {
                  class: "ri-folder-music-fill text-5xl mb-4 text-neutral-200 dark:text-neutral-800"
                }, null, -1)), createBaseVNode("p", _hoisted_23, toDisplayString(unref(t)("localMusic.emptyState")), 1), createBaseVNode("button", {
                  ...
                  class: "ri-folder-add-line mr-2"
                }, null, -1)), createTextVNode(" " + toDisplayString(unref(t)("localMusic.scanFolder")), 1)])])) : filteredList.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_24, [createVNode(_component_n_virtual_list, {
                  ...
                  default: withCtx(({
                    item,
                    index
                  }) => [createBaseVNode("div", null, [createVNode(_sfc_main$1, {
                    index,
                    item,
                    onPlay: handlePlaySong
                  }, null, 8, ["index", "item"]), index === filteredSongResults.value.length - 1 ? (openBlock(), createElementBlock("div", _hoisted_25)) : createCommentVNode("", true)])]),
                  _: 1
                ...
                default: withCtx(() => [createVNode(_component_n_drawer_content, {
                  ...
                  footer: withCtx(() => [createVNode(_component_n_button, {
                    ...
                    icon: withCtx(() => [...(_cache[14] || (_cache[14] = [createBaseVNode("i", {
                      class: "ri-folder-add-line"
                    }, null, -1)]))]),
                    default: withCtx(() => [createTextVNode(" " + toDisplayString(unref(t)("localMusic.scanFolder")), 1)]),
                    _: 1
                  })]),
                  default: withCtx(() => [createBaseVNode("div", _hoisted_26, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(localMusicStore).folderPaths, folder => {
                    ...
                    }, [createBaseVNode("div", _hoisted_27, [_cache[11] || (_cache[11] = createBaseVNode("i", {
                      class: "ri-folder-line text-lg text-primary flex-shrink-0"
                    }, null, -1)), createBaseVNode("span", _hoisted_28, toDisplayString(folder), 1)]), createBaseVNode("button", {
                    ...
                    }, null, -1)]))], 8, _hoisted_29)]);
                  }), 128)), unref(localMusicStore).folderPaths.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_30, [_cache[13] || (_cache[13] = createBaseVNode("i", {
                    class: "ri-folder-line text-4xl text-neutral-200 dark:text-neutral-800"
                  }, null, -1)), createBaseVNode("p", _hoisted_31, toDisplayString(unref(t)("localMusic.emptyState")), 1)])) : createCommentVNode("", true)])]),
                  _: 1
                }, 8, ["title"])]),
                _: 1
              }, 8, ["show"])]);
        ...
        const index = exports("default", /* @__PURE__ */_export_sfc(_sfc_main, [["__scopeId", "data-v-9cf7cb6c"]]));
      }
    };
  });
})();
