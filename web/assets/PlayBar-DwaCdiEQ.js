import { d as defineComponent, a5 as useI18n, A as ref, bm as audioService, aq as onMounted, a7 as openBlock, a8 as createElementBlock, ab as createBaseVNode, b7 as createTextVNode, ac as toDisplayString, ad as unref, aW as isElectron, aY as createBlock, as as withCtx, ce as __unplugin_components_0, ah as createCommentVNode, ak as createVNode, cO as __unplugin_components_1, be as Scrollbar, ae as Fragment, af as renderList, d0 as __unplugin_components_0$1, ap as _export_sfc, bb as usePlayerStore, bF as storeToRefs, Y as watch, ar as onUnmounted, a1 as Button, z as computed, ef as __unplugin_components_1$2, dg as __unplugin_components_3, cN as __unplugin_components_2$1, aa as normalizeClass, h, cH as useSettingsStore, bt as useMessage, eg as playMusic, cf as __unplugin_components_1$3, ag as normalizeStyle, eh as SongSourceConfigManager, d7 as setLxMusicRunner, d6 as initLxMusicRunner, ei as CacheManager, ej as useThrottleFn, ek as nowTime, b1 as useArtist, el as allTime, aQ as getImgUrl, br as __unplugin_components_1$4, bs as __unplugin_components_2$2, em as artistList, a9 as withModifiers, aX as isMobile, en as isLyricWindowOpen, eo as textColors, bv as setAnimationClass, bo as secondToMinute, ep as openLyric } from "./index-BMNXZoHW.js";
import { u as usePlayMode, _ as _sfc_main$5 } from "./MusicFullWrapper.vue_vue_type_script_setup_true_lang-D5gJq35s.js";
import { a as __unplugin_components_2, _ as __unplugin_components_1$1, u as useMusicSources } from "./musicSourceConfig-D5dU1Fh2.js";
import "./index-Ufy0OYbr.js";
import "./Input-C2vwYCZR.js";
import "./Add-CaNEP7Ig.js";
const _hoisted_1$4 = { class: "eq-control p-6 rounded-lg bg-gray-100 dark:bg-gray-900 w-full max-w-[700px]" };
const _hoisted_2$4 = { class: "eq-header flex justify-between items-center mb-4" };
const _hoisted_3$4 = { class: "text-xl font-semibold text-gray-800 dark:text-gray-200" };
const _hoisted_4$4 = { class: "eq-controls" };
const _hoisted_5$4 = { class: "eq-presets mb-2 relative h-10" };
const _hoisted_6$4 = { class: "eq-sliders flex justify-between items-end bg-gray-50 dark:bg-gray-800 gap-1 rounded-lg p-2 h-[300px]" };
const _hoisted_7$4 = { class: "freq-label text-xs font-medium text-center text-gray-600 dark:text-gray-400 whitespace-nowrap m-2 h-5" };
const _hoisted_8$4 = { class: "gain-value text-xs font-medium text-center text-gray-600 dark:text-gray-400 whitespace-nowrap my-1 h-4" };
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const formatFreq = (freq) => {
      if (freq >= 1e3) {
        return "".concat(freq / 1e3, "kHz");
      }
      return "".concat(freq, "Hz");
    };
    return (_ctx, _cache) => {
        ...
        createBaseVNode("div", _hoisted_6$4, [
          (openBlock(), createElementBlock(Fragment, null, renderList(frequencies, (freq) => {
            return createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_7$4, toDisplayString(formatFreq(freq)), 1),
              ...
              createBaseVNode("div", _hoisted_8$4, toDisplayString(eqValues.value[freq.toString()]) + "dB ", 1)
            ]);
          }), 64))
        ])
      ]);
...
const _hoisted_11$1 = { class: "option-section" };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const dropdownOptions = computed(() => [
      ...
      {
        label: t("player.playBar.playbackSpeed") + "(".concat(playbackRate.value, "x)"),
        key: "speed",
        icon: () => h("i", { class: "ri-speed-line" }),
        // 如果播放速度不是1.0，添加标记
        suffix: () => playbackRate.value !== 1 ? h("span", { class: "active-option-mark" }, "".concat(playbackRate.value, "x")) : null
      }
    ]);
...
const _hoisted_4$1 = { class: "mb-3 max-h-80 overflow-y-auto" };
    ...
    const initSelectedSources = () => {
      ...
      if (config && config.sources.length > 0) {
        ...
        if (platform === "lxMusic") {
          ...
          selectedSourceId.value = activeId ? "lxMusic:".concat(activeId) : null;
        } else {
          ...
          createBaseVNode("div", _hoisted_1$1, [
            ...
            createBaseVNode("div", _hoisted_4$1, [
              createBaseVNode("div", _hoisted_5$1, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(groupedSources.value, (group, groupIndex) => {
                  return openBlock(), createElementBlock(Fragment, {
                    key: group.key
                  }, [
                    groupIndex > 0 ? (openBlock(), createElementBlock("div", _hoisted_6$1)) : createCommentVNode("", true),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(group.sources, (source) => {
                      return openBlock(), createElementBlock("div", {
                        key: source.id,
                        class: normalizeClass(["source-button flex items-center p-2 rounded-lg transition-all duration-200", [
                          source.available ? "cursor-pointer bg-light-200 dark:bg-dark-200 hover:bg-light-300 dark:hover:bg-dark-300" : "opacity-40 cursor-not-allowed bg-light-200 dark:bg-dark-200",
                          {
                        ...
                        createBaseVNode("div", {
                          ...
                          style: normalizeStyle({ color: source.color })
                        }, [
                          createBaseVNode("i", {
                        ...
                        createBaseVNode("div", _hoisted_8$1, [
                          ...
                          !source.available && source.configHint ? (openBlock(), createBlock(_component_n_tooltip, {
                            key: 0,
                            trigger: "hover"
                          }, {
                            trigger: withCtx(() => [..._cache[0] || (_cache[0] = [
                              createBaseVNode("i", { class: "ri-information-line text-xs ml-1 opacity-60" }, null, -1)
                            ])]),
                            default: withCtx(() => [
                              createTextVNode(" " + toDisplayString(unref(t)(source.configHint)), 1)
                            ]),
                            _: 2
                          }, 1024)) : createCommentVNode("", true)
                        ]),
                        isReparsing.value && currentReparsingId.value === source.id ? (openBlock(), createElementBlock("div", _hoisted_9$1, [..._cache[1] || (_cache[1] = [
                          createBaseVNode("i", { class: "ri-loader-4-line animate-spin" }, null, -1)
                        ])])) : isCurrentSource(source.id) ? (openBlock(), createElementBlock("div", _hoisted_10$1, [..._cache[2] || (_cache[2] = [
            ...
            createBaseVNode("div", {
              ...
              _cache[3] || (_cache[3] = createBaseVNode("div", { class: "flex items-center justify-center w-6 h-6 mr-3 text-lg" }, [
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const formatTooltip = (value) => {
      return "".concat(secondToMinute(value), " / ").concat(secondToMinute(allTime.value));
    };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["music-play-bar", [
          ...
          musicFullVisible.value && ((_c = (_b = (_a = MusicFullRef.value) == null ? void 0 : _a.musicFullRef) == null ? void 0 : _b.config) == null ? void 0 : _c.hidePlayBar) ? "animate__animated animate__slideOutDown" : ""
        ]]),
        ...
        createBaseVNode("div", {
          ...
          createVNode(_component_n_image, {
            src: unref(getImgUrl)((_d = unref(playMusic)) == null ? void 0 : _d.picUrl, "100y100"),
            class: "play-bar-img",
            lazy: "",
            "preview-disabled": ""
          }, null, 8, ["src"]),
          ((_e = unref(playMusic)) == null ? void 0 : _e.playLoading) ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[7] || (_cache[7] = [
          ...
          createBaseVNode("div", _hoisted_7, [
            createVNode(_component_n_ellipsis, {
              ...
              default: withCtx(() => {
                ...
                return [
                  createBaseVNode("p", {
                    innerHTML: ((_a2 = unref(playMusic)) == null ? void 0 : _a2.name) || ""
                  }, null, 8, _hoisted_8)
                ];
              }),
              _: 1
        ...
        createBaseVNode("div", _hoisted_13, [
          ...
          unref(isElectron) ? (openBlock(), createBlock(_component_n_tooltip, {
            ...
            trigger: withCtx(() => {
              ...
              return [
                createBaseVNode("i", {
                  class: normalizeClass(["iconfont ri-netease-cloud-music-line", { "text-green-500": unref(isLyricWindowOpen), "disabled-icon": !((_a2 = unref(playMusic)) == null ? void 0 : _a2.id) }]),
                  onClick: _cache[5] || (_cache[5] = ($event) => {
                    var _a3;
                    return ((_a3 = unref(playMusic)) == null ? void 0 : _a3.id) && openLyricWindow();
                  })
                }, null, 2)
              ];
            }),
            default: withCtx(() => {
              var _a2;
              return [
                createTextVNode(" " + toDisplayString(((_a2 = unref(playMusic)) == null ? void 0 : _a2.id) ? unref(t)("player.playBar.lyric") : unref(t)("player.playBar.noSongPlaying")), 1)
              ];
            }),
            _: 1
          })) : createCommentVNode("", true),
          ((_f = unref(playMusic)) == null ? void 0 : _f.id) && unref(isElectron) ? (openBlock(), createBlock(_component_n_tooltip, {
            key: 3,
            trigger: "hover",
            "z-index": 9999999
          }, {
            trigger: withCtx(() => {
              var _a2;
              return [
                ((_a2 = unref(playMusic)) == null ? void 0 : _a2.id) ? (openBlock(), createBlock(ReparsePopover, { key: 0 })) : createCommentVNode("", true)
              ];
            }),
            default: withCtx(() => [
              createTextVNode(" " + toDisplayString(unref(t)("player.playBar.reparse")), 1)
...
const PlayBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f9b04433"]]);
export {
  PlayBar as default
};
