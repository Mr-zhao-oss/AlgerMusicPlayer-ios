import { c1 as useMemo, z as computed, A as ref, p as provide, d as defineComponent, E as inject, h, dG as VResizeObserver, cj as mergeProps, bX as useSsrAdapter, bY as cssrAnchorMetaName, aq as onMounted, b6 as onActivated, bi as onDeactivated, ca as depx, dV as beforeNextFrameOnce, bZ as c, a3 as toRef, dA as pxfy } from "./index-BMNXZoHW.js";
function lowBit(n) {
  return n & -n;
}
class FinweckTree {
  ...
  setup(props) {
    ...
    return {
      ...
      visibleItemsStyle: computed(() => {
        finweckTreeUpdateTrigger.value;
        return {
          transform: "translateY(".concat(pxfy(finweckTreeRef.value.sum(startIndexRef.value)), ")")
        };
      }),
