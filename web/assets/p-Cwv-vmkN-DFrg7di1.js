import { aB as o, aI as t, aJ as l, aF as e, aE as f$1, aK as u$1, aL as i, aM as d, aN as d$1, aO as i$1, aP as c } from "./index-BMNXZoHW.js";
/*!
...
const u = /* @__PURE__ */ new WeakMap(), f = (o2, n, t2, i2 = 0, r = false) => {
  ...
  a.style.insetInlineStart = e2 ? r.offsetWidth - n.offsetLeft - n.offsetWidth + "px" : "".concat(n.offsetLeft, "px"), r.appendChild(a), u.set(o2, a);
  const s = e2 ? 9999 : -9999;
  o2.style.pointerEvents = "none", n.style.transform = "translate3d(".concat(s, "px,").concat(t2, "px,0) scale(0)");
}, p = (o2, n) => {
  const t2 = u.get(o2);
  ...
  const i2 = o2[b];
  i2 && clearTimeout(i2), n > 0 ? o2.style.setProperty("--keyboard-offset", "".concat(n, "px")) : o2[b] = setTimeout((() => {
...
const D = "data-ionic-skip-scroll-assist", v = (o2) => {
  ...
  const t2 = o2.getAttribute("id"), i2 = o2.closest('label[for="'.concat(t2, '"]')), r = null === (n = document.activeElement) || void 0 === n ? void 0 : n.closest('label[for="'.concat(t2, '"]'));
