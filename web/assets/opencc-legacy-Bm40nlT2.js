    ...
    return {
      ...
      execute: function () {
        exports({
          ...
          ensureOpenccConverter: ensureOpenccConverter,
          init: init,
        ...
        async function init() {
          if (_inited) return;
          const mod = await __vitePreload(() => module.import('https://cdn.jsdelivr.net/npm/opencc-rust/dist/opencc-rust.mjs'), false              ? __VITE_PRELOAD__ : void 0, module.meta.url);
