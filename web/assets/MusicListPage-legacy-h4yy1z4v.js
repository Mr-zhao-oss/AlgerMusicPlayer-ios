;
(function () {
  System.register(['./index-legacy-B7mtj-uR.js', './main-legacy-CisW2O8D.js', './list-legacy-DrFncIKZ.js', './useScrollTitle-legacy-nHgisOEQ.js', './music-legacy-CGPq9ktk.js', './Input-legacy-D1FyU7q2.js'], function (exports, module) {
    'use strict';

    var defineComponent, useI18n, useRoute, usePlayerStore, useRecommendStore, useUserStore, useMessage, usePlayHistoryStore, watch, useDownload, ref, isMobile, onMounted, openBlock, createElementBlock, createVNode, withCtx, createBaseVNode, __unplugin_components_2, normalizeStyle, unref, getImgUrl, __unplugin_components_1, normalizeClass, withModifiers, createCommentVNode, toDisplayString, __unplugin_components_1$1, isElectron, __unplugin_components_0, createTextVNode, Fragment, renderList, calculateAnimationDelay, _sfc_main$1, Scrollbar, PlayBottom, computed, updatePlaylistTracks, hasPermission, getLoginErrorMessage, subscribeAlbum, subscribePlaylist, nextTick, getMusicDetail, _export_sfc, l, getAlbum, getListDetail, useScrollTitle, useMusicStore, __unplugin_components_0$1;
    return {
      setters: [module => {
        ...
        __unplugin_components_1$1 = module.bH;
        ...
        subscribeAlbum = module.dn;
        subscribePlaylist = module.dp;
        nextTick = module.a2;
      ...
      execute: function () {
        ...
        __vite_style__.textContent = ".music-list-page[data-v-580192e5] {\n  position: relative;\n}\n.hero-section[data-v-580192e5] {\n  min-height: 300px;\n}\n.action-bar[data-v-580192e5] {\n  transition: background-color 0.3s, box-shadow 0.3s;\n}\n.animate-item[data-v-580192e5] {\n  animation: fadeInUp-580192e5 0.6s cubic-bezier(0.16, 1, 0.3, 1) backwards;\n}\n@keyframes fadeInUp-580192e5 {\nfrom {\n    opacity: 0;\n    transform: translateY(20px);\n}\nto {\n    opacity: 1;\n    transform: translateY(0);\n}\n}\n.action-btn-pill[data-v-580192e5] {\n  --tw-border-opacity: 1;\n  border-color: rgb(229 229 229 / var(--tw-border-opacity, 1));\n  transition-property: all;\n  transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n  transition-duration: 150ms;\n}\n.action-btn-pill[data-v-580192e5]:is(.dark *) {\n  --tw-border-opacity: 1;\n  border-color: rgb(38 38 38 / var(--tw-border-opacity, 1));\n}\n.action-btn-pill[data-v-580192e5]:hover:not(:disabled) {\n  border-color: rgb(34 197 94 / 0.3);\n  background-color: rgb(34 197 94 / 0.05);\n}\n.action-btn-icon[data-v-580192e5] {\n  transition-property: all;\n  transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n  transition-duration: 150ms;\n}\n.action-btn-icon[data-v-580192e5]:hover {\n  --tw-scale-x: 1.1;\n  --tw-scale-y: 1.1;\n  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));\n  background-color: rgb(34 197 94 / 0.1);\n  --tw-text-opacity: 1;\n  color: rgb(34 197 94 / var(--tw-text-opacity, 1));\n}\n.song-list-container[data-v-580192e5] {\n  padding-bottom: 100px;\n}\n.song-highlight[data-v-580192e5] {\n  animation: highlightPulse-580192e5 2s ease-out;\n}\n@keyframes highlightPulse-580192e5 {\n0%, 30% {\n    background-color: rgba(var(--primary-color-rgb, 64, 128, 255), 0.15);\n    border-radius: 12px;\n}\n100% {\n    background-color: transparent;\n}\n}\n.mobile .hero-section[data-v-580192e5] {\n  min-height: auto;\n}\n.mobile .action-bar[data-v-580192e5] {\n  padding-top: 0.5rem;\n  padding-bottom: 0.5rem;\n}/*$vite$:1*/";
        document.head.appendChild(__vite_style__);
        const _hoisted_1 = {
          class: "music-list-page h-full w-full bg-white dark:bg-black transition-colors duration-500"
        };
        const _hoisted_2 = {
          class: "music-list-content pb-32"
        };
        const _hoisted_3 = {
        ...
        const _hoisted_5 = {
          class: "hero-content relative z-10 page-padding-x pt-4 md:pt-10 pb-8"
        };
        const _hoisted_6 = {
          class: "flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-end"
        };
        const _hoisted_7 = {
        ...
        const _hoisted_9 = {
          class: "playlist-info flex-1 text-center md:text-left"
        };
        const _hoisted_10 = {
          class: "playlist-badge mb-3"
        };
        const _hoisted_11 = {
        ...
        const _hoisted_29 = {
          class: "song-list-section page-padding-x mt-6"
        };
        const _hoisted_30 = {
          key: 0,
        ...
        const _sfc_main = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            const fetchData = async () => {
              ...
              if (musicStore.currentListInfo?.id?.toString() === id.toString() && musicStore.currentMusicList && musicStore.currentMusicList.length > 0) {
                return;
              }
              loading.value = true;
              try {
                ...
                if (type === "album") {
                  ...
                  data = res.data;
                  if (data.code === 200) {
                    musicStore.setCurrentMusicList(data.songs, data.album.name, {
                      ...data.album,
                  ...
                  if (data.code === 200) {
                    ...
                    musicStore.setCurrentMusicList(playlist.tracks || [], playlist.name, playlist, playlist.creator?.userId === userStore.user?.userId);
                  } else {
                    message.error(t("common.loadFailed"));
                  }
                }
            ...
            const filteredSongs = computed(() => {
              if (searchKeyword.value) {
                ...
                return allFilteredSongs.value.filter(song => {
                  ...
                  return songName.includes(keyword) || albumName.includes(keyword) || artists.some(a => a.name?.toLowerCase().includes(keyword)) || l.match(songName, keyword);
                });
              }
            ...
            const loadMoreSongs = async () => {
              if (isFullPlaylistLoaded.value || searchKeyword.value || displayedSongs.value.length >= total.value) return;
            ...
            const toggleCollect = async () => {
              ...
              try {
                ...
                if (response.data.code === 200) {
                  ...
                  message.success(t(isCollected.value ? "comp.musicList.collectSuccess" : "comp.musicList.cancelCollectSuccess"));
                  if (type === "album") {
            ...
            const isAllSelected = computed(() => filteredSongs.value.length > 0 && selectedSongs.value.length === filteredSongs.value.length);
            const isIndeterminate = computed(() => selectedSongs.value.length > 0 && selectedSongs.value.length < filteredSongs.value.length);
            ...
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(_component_n_scrollbar, {
                ...
                default: withCtx(() => [createBaseVNode("div", _hoisted_2, [createVNode(_component_n_spin, {
                  show: loading.value
                }, {
                  default: withCtx(() => [createBaseVNode("section", _hoisted_3, [createBaseVNode("div", _hoisted_4, [createBaseVNode("div", {
                    class: "absolute inset-0 bg-cover bg-center scale-110 blur-3xl opacity-40 dark:opacity-30",
                    style: normalizeStyle({
                      backgroundImage: `url(${unref(getImgUrl)(getCoverImgUrl.value, "800y800")})`
                    })
                  ...
                  }, null, -1))]), createBaseVNode("div", _hoisted_5, [createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [_cache[5] || (_cache[5] = createBaseVNode("div", {
                  ...
                  }, null, -1)), createBaseVNode("div", _hoisted_8, [createVNode(_component_n_image, {
                    src: unref(getImgUrl)(getCoverImgUrl.value, "500y500"),
                    class: "w-full h-full object-cover transition-transform duration-700 group-hover:scale-110",
                    "preview-disabled": ""
                  }, null, 8, ["src"]), createBaseVNode("div", {
                    ...
                    class: "ri-play-fill text-3xl text-neutral-900 ml-1"
                  }, null, -1)]))])) : createCommentVNode("", true)], 2)])]), createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, [createBaseVNode("span", _hoisted_11, toDisplayString(isAlbum.value ? "Album" : "Playlist"), 1)]), createBaseVNode("h1", {
                    ref_key: "titleElRef",
                    ref: titleElRef,
                    class: "playlist-name text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white tracking-tight mb-4"
                  }, toDisplayString(name.value), 513), createBaseVNode("div", _hoisted_12, [isAlbum.value && listInfo.value?.artist ? (openBlock(), createElementBlock("div", _hoisted_13, [createVNode(_component_n_avatar, {
                    round: "",
                    size: 28,
                    src: unref(getImgUrl)(listInfo.value.artist.picUrl, "50y50")
                  }, null, 8, ["src"]), createBaseVNode("span", _hoisted_14, toDisplayString(listInfo.value.artist.name), 1)])) : !isAlbum.value && listInfo.value?.creator ? (openBlock(), createElementBlock("div", _hoisted_15, [createVNode(_component_n_avatar, {
                    round: "",
                    size: 28,
                    src: unref(getImgUrl)(listInfo.value.creator.avatarUrl, "50y50")
                  }, null, 8, ["src"]), createBaseVNode("span", _hoisted_16, toDisplayString(listInfo.value.creator.nickname), 1)])) : createCommentVNode("", true), _cache[6] || (_cache[6] = createBaseVNode("div", {
                    class: "h-1 w-1 rounded-full bg-neutral-300 dark:bg-neutral-700"
                  }, null, -1)), createBaseVNode("span", _hoisted_17, toDisplayString(unref(t)("player.songNum", {
                    num: total.value
                  })), 1)]), listInfo.value?.description ? (openBlock(), createElementBlock("p", _hoisted_18, toDisplayString(listInfo.value.description), 1)) : createCommentVNode("", true)])])])])]),
                  _: 1
                }, 8, ["show"]), songList.value.length > 0 ? (openBlock(), createElementBlock("section", _hoisted_19, [createBaseVNode("div", _hoisted_20, [createBaseVNode("div", _hoisted_21, [createBaseVNode("button", {
                  ...
                  class: "ri-play-circle-line text-base md:text-lg"
                }, null, -1)), createBaseVNode("span", null, toDisplayString(unref(t)("comp.musicList.playAll")), 1)]), canCollect.value ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  class: normalizeClass(["action-btn-pill flex items-center gap-1.5 md:gap-2 px-3.5 md:px-6 py-1.5 md:py-2.5 rounded-full font-semibold text-xs md:text-sm transition-all duration-200 hover:scale-105 active:scale-95 shadow-sm border", isCollected.value ? "bg-neutral-100 dark:bg-neutral-800 text-red-500 border-neutral-200 dark:border-neutral-700" : "bg-neutral-50 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 border-neutral-200 dark:border-neutral-800"]),
                  onClick: toggleCollect
                }, [createBaseVNode("i", {
                  class: normalizeClass([isCollected.value ? "ri-heart-fill" : "ri-heart-line", "text-base md:text-lg"])
                }, null, 2), createBaseVNode("span", null, toDisplayString(isCollected.value ? unref(t)("comp.musicList.cancelCollect") : unref(t)("comp.musicList.collect")), 1)], 2)) : createCommentVNode("", true), filteredSongs.value.length > 0 && unref(isElectron) ? (openBlock(), createElementBlock("div", _hoisted_22)) : createCommentVNode("", true), !isSelecting.value && unref(isElectron) ? (openBlock(), createElementBlock("button", {
                  key: 2,
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  onClick: startSelect
                }, [...(_cache[8] || (_cache[8] = [createBaseVNode("i", {
                  class: "ri-checkbox-multiple-line text-lg"
                }, null, -1)]))])) : createCommentVNode("", true), isSelecting.value ? (openBlock(), createElementBlock("div", _hoisted_23, [createVNode(_component_n_checkbox, {
                  checked: isAllSelected.value,
                  indeterminate: isIndeterminate.value,
                  "onUpdate:checked": handleSelectAll
                }, {
                  default: withCtx(() => [createTextVNode(toDisplayString(unref(t)("common.selectAll")), 1)]),
                  _: 1
                }, 8, ["checked", "indeterminate"]), createBaseVNode("button", {
                  ...
                  class: "ri-download-line mr-1"
                }, null, -1)), createTextVNode(" " + toDisplayString(unref(t)("favorite.download", {
                  count: selectedSongs.value.length
                })), 1)], 8, _hoisted_24), createBaseVNode("button", {
                  class: "px-4 py-1.5 rounded-full bg-primary/10 text-primary text-xs font-bold hover:bg-primary/20 transition-all",
                  disabled: selectedSongs.value.length === 0,
                  onClick: handleAddToPlaylist
                }, [_cache[10] || (_cache[10] = createBaseVNode("i", {
                  class: "ri-play-list-add-line mr-1"
                }, null, -1)), createTextVNode(" " + toDisplayString(unref(t)("comp.musicList.addToPlaylist")), 1)], 8, _hoisted_25), createBaseVNode("button", {
                  class: "text-xs text-neutral-400 hover:text-neutral-600",
                  onClick: cancelSelect
                }, toDisplayString(unref(t)("common.cancel")), 1)])) : createCommentVNode("", true)]), createBaseVNode("div", _hoisted_26, [createBaseVNode("div", _hoisted_27, [createVNode(_component_n_input, {
                  ...
                  prefix: withCtx(() => [...(_cache[11] || (_cache[11] = [createBaseVNode("i", {
                    class: "ri-search-line text-neutral-400"
                  }, null, -1)]))]),
                  _: 1
                }, 8, ["value", "placeholder"])]), currentPlayingIndex.value >= 0 ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  title: unref(t)("comp.musicList.locateCurrent", "定位当前播放"),
                  onClick: scrollToCurrentSong
                }, [...(_cache[12] || (_cache[12] = [createBaseVNode("i", {
                  class: "ri-focus-3-line text-lg"
                }, null, -1)]))], 8, _hoisted_28)) : createCommentVNode("", true), !unref(isMobile) ? (openBlock(), createElementBlock("button", {
                  key: 1,
                  class: "action-btn-icon w-10 h-10 rounded-full flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all",
                  onClick: toggleLayout
                }, [createBaseVNode("i", {
                  class: normalizeClass([isCompactLayout.value ? "ri-list-check-2" : "ri-grid-line", "text-lg"])
                }, null, 2)])) : createCommentVNode("", true)])])])) : createCommentVNode("", true), createBaseVNode("section", _hoisted_29, [filteredSongs.value.length === 0 && searchKeyword.value ? (openBlock(), createElementBlock("div", _hoisted_30, [_cache[13] || (_cache[13] = createBaseVNode("i", {
                  class: "ri-search-line text-4xl mb-4 opacity-20"
                }, null, -1)), createBaseVNode("p", null, toDisplayString(unref(t)("comp.musicList.noSearchResults")), 1)])) : (openBlock(), createElementBlock("div", _hoisted_31, [(openBlock(true), createElementBlock(Fragment, null, renderList(filteredSongs.value, (item, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: item.id,
                    class: normalizeClass(["mb-2", {
                      "animate-item": index < initialAnimateCount
                    }]),
                    style: normalizeStyle(index < initialAnimateCount ? {
                  ...
                  }, null, 8, ["index", "compact", "item", "can-remove", "selectable", "selected", "onPlay"])], 6);
                }), 128)), placeholderHeight.value > 0 ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  style: normalizeStyle({
                    height: placeholderHeight.value + "px"
                  })
                }, null, 4)) : createCommentVNode("", true), loadingList.value ? (openBlock(), createElementBlock("div", _hoisted_32, [createVNode(_component_n_spin, {
                  size: 18
                }), createBaseVNode("span", _hoisted_33, toDisplayString(unref(t)("common.loading")), 1)])) : !hasMore.value && renderLimit.value >= allFilteredSongs.value.length && filteredSongs.value.length > 0 && !searchKeyword.value ? (openBlock(), createElementBlock("div", _hoisted_34, " — " + toDisplayString(unref(t)("common.noMore")) + " — ", 1)) : createCommentVNode("", true)]))])])]),
                _: 1
        ...
        const MusicListPage = exports("default", /* @__PURE__ */_export_sfc(_sfc_main, [["__scopeId", "data-v-580192e5"]]));
      }
    };
  });
})();
